...
class RmeFormValidation
{
	...
	* */
	...
	function rm3b($payload)
	{
		...
		$this->CI->form_validation->set_rules('id_kunjungan', 'ID Kunjungan', 'required');
		$this->CI->form_validation->set_rules('nama_berkas', 'Nama Berkas', 'required');
		$this->CI->form_validation->set_rules('setuju_tindakan_kedokteran', 'Setuju tindakan Kedokteran', 'required');
	...
	function rm3e($payload)
	{
		...
		$this->CI->form_validation->set_rules('id_kunjungan', 'ID Kunjungan', 'required');
		$this->CI->form_validation->set_rules('nama_berkas', 'Nama Berkas', 'required');
		$this->CI->form_validation->set_rules('penolakan_pengobatan', 'Penolakan Pengobatan', 'required');
	...
	function rm3f($payload)
	{
		...
		$this->CI->form_validation->set_rules('id_kunjungan', 'ID Kunjungan', 'required');
		$this->CI->form_validation->set_rules('nama_berkas', 'Nama Berkas', 'required');
		$this->CI->form_validation->set_rules('persetujuan_tindakan', 'persetujuan tindakan', 'required');
	...
	function rm3g($payload)
	{
		...
		$this->CI->form_validation->set_rules('id_kunjungan', 'ID Kunjungan', 'required');
		$this->CI->form_validation->set_rules('nama_berkas', 'Nama Berkas', 'required');
		$this->CI->form_validation->set_rules('penolakan_tindakan', 'penolakan tindakan', 'required');
