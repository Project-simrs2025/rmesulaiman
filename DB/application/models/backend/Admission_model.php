...
class Admission_model extends CI_Model
{
	...
	private function _get_datatables_query()
	{
		...
		$this->postgres->select('admission.*, p.nama AS nama_pasien, lt.nama_lantai, ru.nama_ruangan, k.nama AS nama_jenis_pasien,bed.no_bad,dokter.nama as nama_dokter,poli.name as nama_poli');
	...
	// radiologi
	public function get_all_radio($searchQuery, $limit, $offset)
	{
		$this->postgres->select('id, nama');
		$this->postgres->from('radio');
	...
	public function count_all_radio($searchQuery = null)
	{
		$this->postgres->from('radio');
