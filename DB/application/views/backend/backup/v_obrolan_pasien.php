...
data: csfrData
        ...
        function pesan() {
            ...
            var id_lawan = '<?= $id_pasien ?>'
            $.ajax({
                type: "post",
                url: '<?php echo site_url("backend/konsultasi/loadChatDokter");?>',
                data: {
                    id : '<?= $id_dokter ?>',
                    id_lawan: id_lawan
                },
        ...
        $('.send_btn').on('click', (e) =>{
                ...
                var id_dokter = '<?= $id_dokter; ?>';
                var id_pasien = '<?= $id_pasien; ?>';
...
$this->security->get_csrf_hash(); ?>');
                ...
                $.ajax({
                    url: '<?php echo site_url("backend/konsultasi/KirimPesanDokter");?>',
                    method : 'POST',
                    data   : fd,
                    type  : 'GET',
                    processData: false,
