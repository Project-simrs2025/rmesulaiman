<table class="table table-borderless ">
    ...
    <tr>
        <td rowspan="3">
            <p>
                <img class="marker-image" id="example-image" src="<?= base_url('assets/images/rme/rm18bc/rm18bc_gambar (7).jpeg') ?>" style="width: 600px;height:550px;" data-input-name="image_drawer_state_image_7" />
