...
<table class="table table-borderless border-dark">
    <tr>
        <td></td>
        <td>
            <p><strong>No. RM : <input type="text" class="form-control border-dark" name="no+rm" value="RM 18 C" disabled></strong></p>
    ...
    <tr>
        <td colspan="3">
            <p><strong>FORMULIR PENANDAAN LOKASI OPERASI (PRIA)</strong></p>
        </td>
    </tr>
    <tr>
        <td colspan="3">
            <div class="d-flex align-items-center gap-2">
                ...
                <input type="date" class="form-control border-dark" name="18c_tanggal" value="<?= date('Y-m-d') ?>">

                <label for="" class="flex-shrink-0">Waktu :</label>
                <input type="time" class="form-control border-dark" name="18c_waktu">
            </div>
        </td>
    </tr>
    <tr>
        <td colspan="3">
            <p>Jenis Operasi : <input type="text" class="form-control border-dark" name="18c_jenis_operasi"></p>
        </td>
    </tr>
    <tr>
        <td rowspan="3">
            <p>
                <img class="marker-image" id="example-image" src="<?= base_url('assets/images/rme/rm18bc/rm18bc_gambar (3).png') ?>" style="width: 600px;height:550px;" data-input-name="image_drawer_state_image_1" />
                <input type="hidden" id="image_drawer_state_image_1" name="image_drawer_state_image_1" value="" />
            </p>
        </td>
        <td colspan="2">
            <p>
                <img class="marker-image" id="example-image" src="<?= base_url('assets/images/rme/rm18bc/rm18bc_gambar (1).png') ?>" style="max-width: 600px" data-input-name="image_drawer_state_image_2" />
    ...
    <tr>
        <td colspan="2">
            <p>
                <img class="marker-image" id="example-image" src="<?= base_url('assets/images/rme/rm18bc/rm18bc_gambar (4).png') ?>" style="max-width: 600px" data-input-name="image_drawer_state_image_3" />
    ...
    <tr>
        <td colspan="2">
            <p>
                <img class="marker-image" id="example-image" src="<?= base_url('assets/images/rme/rm18bc/rm18bc_gambar (5).png') ?>" style="max-width: 600px" data-input-name="image_drawer_state_image_4" />
    ...
    <tr>
        <td>
            <p>
                <img class="marker-image" id="example-image" src="<?= base_url('assets/images/rme/rm18bc/rm18bc_gambar (6).png') ?>" style="max-width: 600px" data-input-name="image_drawer_state_image_5" />
                <input type="hidden" id="image_drawer_state_image_5" name="image_drawer_state_image_5" value="" />
            </p>
        </td>
        <td colspan="2">
            <p>
                <img class="marker-image" id="example-image" src="<?= base_url('assets/images/rme/rm18bc/rm18bc_gambar (2).png') ?>" style="max-width: 600px" data-input-name="image_drawer_state_image_6" />
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex flex-column" style="gap: 20px">
                    ...
                    <img class="marker-image" id="example-image" src="<?= base_url('assets2/rme/img/testttd.png') ?>"
                        style="width: 350px; height:200px;" data-input-name="image_drawer_state_image_1_tdd" />
                    <input type="hidden" id="image_drawer_state_image_1_tdd" name="image_drawer_state_image_1_tdd"
                        value="" />
                    <input type="text" class="form-control border-dark" name="18c_nama_pasien_keluarga">
                </div>
