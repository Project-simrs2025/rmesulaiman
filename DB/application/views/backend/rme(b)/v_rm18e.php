        ...
        <tbody>
            <tr>
                ...
                <td colspan="2">
                    ...
                    <input type="text" class="w-100 form-control border-dark" name="nama_asistant">
                </td>
                <td>
                    <label for="">Nama Perawat :</label>
                    <input type="text" class="w-100 form-control border-dark" name="nama_perawat">
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    <div class="form-group">
                        <input type="radio" name="macam_pembedahan" value="bedah_besar" id="bedah_besar" class="custom-checkbox-success"> <label for="bedah_besar" class="col-2">Besar</label>
                        <input type="radio" name="macam_pembedahan" value="bedah_elective" id="bedah_elective" class="custom-checkbox-success"> <label for="bedah_elective">Elective</label>
                    </div>
                    <div class="form-group">
                        <input type="radio" name="macam_pembedahan" value="bedah_sedang" id="bedah_sedang" class="custom-checkbox-success"> <label for="bedah_sedang" class="col-2">Sedang</label>
                        <input type="radio" name="macam_pembedahan" value="bedah_emergency" id="bedah_emergency" class="custom-checkbox-success"> <label for="bedah_emergency">Emergency</label>
                    </div>
                    <div class="form-group">
                        <input type="radio" name="macam_pembedahan" value="bedah_kecil" id="bedah_kecil" class="custom-checkbox-success"> <label for="bedah_kecil">Kecil</label>
                        <!-- hidden -->
                        <input type="radio" name="macam_pembedahan" value="bedah_kecil" id="bedah_kecil" class="custom-checkbox-success" style="visibility: hidden;"> <label for="bedah_kecil" style="visibility: hidden;">Kecil</label>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="time" class="w-100 form-control border-dark">
                </td>
                <td>
