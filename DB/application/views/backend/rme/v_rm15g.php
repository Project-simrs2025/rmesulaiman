...
<div class="row">
    <table class="table table-bordered border-dark">
        <tbody>
            <tr>
                <td>
                    <img class="marker-image" id="example-image" src="<?= base_url('assets2/rme/img/pastograf_denyut.png') ?>"
                        style="height:400px;" data-input-name="image_drawer_state_image_3" />
...
<div class="row">
    <table class="table table-bordered border-dark">
        ...
        <tbody>
            <tr>
                <img class="marker-image" id="example-image" src="<?= base_url('assets2/rme/img/pastograf_pembukaan.png') ?>"
                    style="height:400px;" data-input-name="image_drawer_state_image_pembukaan" />
...
<div class="row">
    <table class="table table-bordered border-dark">
        <tr>
            <img class="marker-image" id="example-image" src="<?= base_url('assets2/rme/img/pastograf_kontraksi.png') ?>"
                style="height:400px;" data-input-name="image_drawer_state_image_kontraksi" />
...
<div class="row">
    <table class="table table-bordered border-dark">
        <img class="marker-image" id="example-image" src="<?= base_url('assets2/rme/img/pastograf_nadi.png') ?>"
            style="height:400px;" data-input-name="image_drawer_state_image_nadi" />
