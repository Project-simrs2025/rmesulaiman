...
<table class="table table-borderless border-dark">
    ...
    <tr>
        <td rowspan="3">
            <p>
                <img class="marker-image" id="setting_img" src="<?= base_url('assets/images/rme/rm18bc/rm18bc_gambar (3).png') ?>" style="width: 600px;height:430px;" data-input-name="image_drawer_state_image_1" />
