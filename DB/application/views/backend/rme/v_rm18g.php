            ...
            <div class="operation-details">
                ...
                <div class="d-flex align-items-center gap-2 mb-2 flex-wrap">
                    ...
                    <div class="d-flex gap-2 flex-wrap w-100 ms-5">
                        ...
                        <div class="d-flex w-100 gap-2">
                            <input type="radio" class="custom-checkbox-success" id="lain-lain" name="PosisiOperasi" value="lain-lain" onclick="toggleInputFocus()" />
                            <div class="d-flex align-items-center gap-2 w-100">
                                <label for="lain-lain" class="col-1">Lain-lain</label>
                                <input type="text" class="form-control border-dark d-inline w-100 mx-2" name="DiawasiOleh" id="diawasiOlehInput" placeholder="Diawasi oleh" readonly />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center gap-2 mb-2 flex-wrap">
                    ...
                    <div class="d-flex gap-2 flex-wrap w-100 ms-5">
                        ...
                        <div class="col-4">
                            <input type="radio" class="custom-checkbox-success" id="ya" name="MemakaiKateterUrine" value="ya" />
