    ...
    <div class="col-12">
        <table class="table table-bordered mt-3 border-dark">
            <tbody class="text-center">
                ...
                <th>Tanggal</th>
                <th>Metode/Durasi</th>
                <th class="col-2">Evaluasi Pasien/Keluarga</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="date" name="tanggal1" id="tanggal1" class="form-control border-dark"></td>
                    <td>
                        <div>
                    ...
                    <td><input type="text" name="paraf_penerima1" id="paraf_penerima1" class="form-control border-dark"></td>
                    <td><input type="text" name="paraf_educator1" id="paraf_educator1" class="form-control border-dark"></td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>
                    ...
                    <td><input type="text" name="paraf_penerima2" id="paraf_penerima2" class="form-control border-dark"></td>
                    <td><input type="text" name="paraf_educator2" id="paraf_educator2" class="form-control border-dark"></td>
                </tr>
                <tr>
                    <td>3</td>
                    <td>
                    ...
                    <td><input type="text" name="paraf_penerima3" id="paraf_penerima3" class="form-control border-dark"></td>
                    <td><input type="text" name="paraf_educator3" id="paraf_educator3" class="form-control border-dark"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="paraf_penerima4" id="paraf_penerima4" class="form-control border-dark"></td>
                    <td><input type="text" name="paraf_educator4" id="paraf_educator4" class="form-control border-dark"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="paraf_penerima5" id="paraf_penerima5" class="form-control border-dark"></td>
                    <td><input type="text" name="paraf_educator5" id="paraf_educator5" class="form-control border-dark"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="paraf_penerima6" id="paraf_penerima6" class="form-control border-dark"></td>
                    <td><input type="text" name="paraf_educator6" id="paraf_educator6" class="form-control border-dark"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="paraf_penerima7" id="paraf_penerima7" class="form-control border-dark"></td>
                    <td><input type="text" name="paraf_educator7" id="paraf_educator7" class="form-control border-dark"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="paraf_penerima8" id="paraf_penerima8" class="form-control border-dark"></td>
                    <td><input type="text" name="paraf_educator8" id="paraf_educator8" class="form-control border-dark"></td>
                </tr>
            </tbody>
        </table>
    </div>
