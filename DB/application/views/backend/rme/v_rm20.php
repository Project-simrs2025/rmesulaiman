    ...
    <div class="col-12">
        <table class="table table-bordered border-dark">
            ...
            <tr>
                ...
                <td colspan="4">
                    ...
                    <p>Ruang : <input type="text" class="form-control border-dark" name="nama_ruangan" placeholder="Ruang"></p>
        ...
        <table class="table table-bordered border-dark" id="table-resiko">
            <tr>
                ...
                <td><input type="text" name="ket_rr_1[]" id="" class="form-control border-dark" placeholder="RR/RS/RT"></td>
                <td><input type="text" name="ket_rr_2[]" id="" class="form-control border-dark" placeholder="RR/RS/RT"></td>
            </tr>
            <tr>
                <td colspan="7">
