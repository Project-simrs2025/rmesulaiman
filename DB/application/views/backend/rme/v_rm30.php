        ...
        <table class="table table-bordered border-dark">
            <tbody>
                ...
                <tr>
                    <td><strong>Diagnosa Medis</strong></td>
                    <td>
                        <select type="select" name="diagnosa_tb<?= $i; ?>_pagi" id="diagnosa_tb<?= $i; ?>_pagi" class="form-select diagnosa w-100"></select>
                    </td>
                    <td>
                        <select type="select" name="diagnosa_tb<?= $i; ?>_sore" id="diagnosa_tb<?= $i; ?>_sore" class="form-select diagnosa w-100"></select>
                    </td>
                    <td>
                        <select type="select" name="diagnosa_tb<?= $i; ?>_malam" id="diagnosa_tb<?= $i; ?>_malam" class="form-select diagnosa w-100"></select>
                    </td>
                </tr>
                <tr>
                    <td><strong>Masalah keperawatan</strong></td>
    ...
    $(document).ready(function() {
        ...
        for (let i = 1; i <= 3; i++) {
            ['pagi', 'sore', 'malam'].forEach(shift => {
                initializeSelect2(`#diagnosa_tb${i}_${shift}`);
            });
        }
    });
