                ...
                <td>
                    <div class="d-flex flex-column gap-2 align-items-center">
                        ...
                        <input type="hidden" id="image_drawer_state_image_11" name="image_drawer_state_image_11"
                            value="" />
                        <input type="text" class="form-control border-dark mt-2" name="nama_tdd_pasien_keluarga" placeholder="nama pasien atau keluarga">
                    </div>
                </td>
            </tr>
                ...
                <td colspan="4">
                    ...
                    <div class="row mt-3">
                        <div class="main-persetujuan d-flex align-items-center flex-wrap gap-2">
                            ...
                            <input type="text" class="form-control border-dark w-50 my-1" name="alamat" disabled> <label for="" class="mx-1">dengan ini menyatakan <span class="fw-bold"> penolakan </span>untuk dilakukannya tindakan</label><input type="text" class="form-control border-dark w-50 my-1" name="penolakan_tindakan"> <label for="" class="mx-1">terhadap saya / </label>
                            ...
                            <input type="text" class="form-control border-dark w-50 my-1" name="alamat" disabled>
                        ...
                        <div class="col-4">
                            <div class="d-flex flex-column gap-2">
                                ...
                                <input type="hidden" id="image_drawer_state_image_2" name="image_drawer_state_image_2"
                                    value="" />
                                <input type="text" class="form-control border-dark mt-2" name="nama_tdd_pasien" placeholder="nama pasien">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="d-flex flex-column gap-2">
                                ...
                                <input type="hidden" id="image_drawer_state_image_3" name="image_drawer_state_image_3"
                                    value="" />
                                <input type="text" class="form-control border-dark mt-2" name="nama_tdd_keluarga" placeholder="nama keluarga">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="d-flex flex-column gap-2">
