...
<div class="content-wrapper container">
	<div class="page-content">
					...
					<nav aria-label="breadcrumb" class='breadcrumb-header float-start float-lg-end'>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a
									href="<?php echo site_url('backend/admission'); ?>">Admission</a></li>
		...
		<section id="input-validation">
			<h3><a href="<?php echo site_url('backend/admission'); ?>"><i class="bi bi-chevron-left"></i><i
			...
			function click_menu(nama_berkas) {
				...
				$.ajax({
					...
					success: function (
						...
						if (selected_data) {
							canAdd = false
							const urlEdit = `<?= site_url('backend/admission/edit'); ?>/${selected_data.id}`
							const urlView = `<?= site_url('backend/admission/lihat'); ?>/${selected_data.id}`
