...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 03, 2025 at 02:57 AM
...
CREATE TABLE IF NOT EXISTS `detail_website` (
  `detail_website_id` int NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `menurme`;
CREATE TABLE IF NOT EXISTS `menurme` (
...
(1, 'RM 1', 'PENGKAJIAN AWAL PASIEN RAWAT JALAN', 'rm1', 1),
(2, 'RM 1a', 'RESUME MEDIS RAWAT JALAN', 'rm1a', 1),
(3, 'RM 1b', 'PENCATATAN PELAYANAN KESEHATAN GIGI & MULUT', 'rm1b', 1),
(4, 'RM 1c', 'CHECKLIST KESELAMATAN POLIKLINIK GIGI & MULUT', 'rm1c', 1),
(5, 'RM 1d', 'LAYANAN KEDOKTERAN FISIK & REHABILITAS RAWAT JALAN', 'rm1d', 1),
(6, 'RM 1e', 'LAYANAN KEDOKTERAN FISIK & REHABILITAS', 'rm1e', 1),
(7, 'RM 1f', 'LEMBAR HASIL TINDAKAN', 'rm1f', 1),
(8, 'RM 2', 'PENGKAJIAN MEDIS & KEPERAWATAN GAWAT DARURAT', 'rm2', 1),
(9, 'RM 2a & 2b', 'FORMULIR TRIAGE ANAK & FORMULIR TRIAGE DEWASA', 'rm2ab', 1),
(10, 'RM 3', 'SURAT PENGANTAR UNTUK RAWAT INAP', 'rm3', 1),
(11, 'RM 3a', 'FORMULIR TRANSFER PASIEN INTRA RUMAH SAKIT', 'rm3a', 1),
(12, 'RM 3b', 'PERSETUJUAN TINDAKAN KEDOKTERAN', 'rm3b', 1),
(13, 'RM 3c', 'FORMULIR PENOLAKAN TINDAKAN KEDOKTERAN', 'rm3c', 1),
(14, 'RM 3d', 'PERSETUJUAN UMUM  GENERAL CONSENT', 'rm3d', 1),
(15, 'RM 3e', 'SURAT PERNYATAAN PENOLAKAN PENGOBATAN', 'rm15', 1),
(16, 'RM 3f', 'PERSETUJUAN TRANSFUSI DARAH', 'rm65', 1),
