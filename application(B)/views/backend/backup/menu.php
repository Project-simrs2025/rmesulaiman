...
<div class="sidebar-wrapper active">
    <div class="sidebar-header position-relative">
        <div class="logo">
            ...
            ><img src="<?php echo base_url().'assets/images/logo/'.$images;?>" alt="Logo" srcset="<?php echo base_url().'assets/images/logo/'.$images;?>" style="width:20%; height:20%; float:left; margin-right:4px;"/><h5 style="padding-top:10px;">Selamat Datang</h5></a>
        </div>
        <br/>
...
<div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-item <?php echo $this->uri->segment(2) == 'admission' ? 'active': '' ?>">
                <a href="<?php echo site_url('backend/admission');?>" class='sidebar-link'>
