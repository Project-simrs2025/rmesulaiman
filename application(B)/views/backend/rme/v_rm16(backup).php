			...
			<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="mb-2">
							<div class="form-check">
								<input class="custom-checkbox-success" type="checkbox" name="pemeriksaan_bayi_setelah_lahir_kepala" id="pemeriksaan_kepala">
						...
						<div class="mb-2">
							<div class="form-check">
								<input class="custom-checkbox-success" type="checkbox" name="pemeriksaan_bayi_setelah_lahir_kulit" id="pemeriksaan_kulit">
						...
						<div class="mb-2">
							<div class="form-check">
								<input class="custom-checkbox-success" type="checkbox" name="pemeriksaan_bayi_setelah_lahir_mata" id="pemeriksaan_mata">
						...
						<div class="mb-2">
							<div class="form-check">
								<input class="custom-checkbox-success" type="checkbox" name="pemeriksaan_bayi_setelah_lahir_hidung" id="pemeriksaan_hidung">
						...
						<div class="mb-2">
							<div class="form-check">
								<input class="custom-checkbox-success" type="checkbox" name="pemeriksaan_bayi_setelah_lahir_mulut" id="pemeriksaan_mulut">
						...
						<div class="mb-2">
							<div class="form-check">
								<input class="custom-checkbox-success" type="checkbox" name="pemeriksaan_bayi_setelah_lahir_telinga" id="pemeriksaan_telinga">
					...
					<div class="col-md-6">
						<div class="mb-2">
							<div class="form-check">
								<input class="custom-checkbox-success" type="checkbox" name="pemeriksaan_bayi_setelah_lahir_jantung" id="pemeriksaan_jantung">
						...
						<div class="mb-2">
							<div class="form-check">
								<input class="custom-checkbox-success" type="checkbox" name="pemeriksaan_bayi_setelah_lahir_paru" id="pemeriksaan_paru">
						...
						<div class="mb-2">
							<div class="form-check">
								<input class="custom-checkbox-success" type="checkbox" name="pemeriksaan_bayi_setelah_lahir_abdomen" id="pemeriksaan_abdomen">
						...
						<div class="mb-2">
							<div class="form-check">
								<input class="custom-checkbox-success" type="checkbox" name="pemeriksaan_bayi_setelah_lahir_genetelia" id="pemeriksaan_genitalia">
						...
						<div class="mb-2">
							<div class="form-check">
								<input class="custom-checkbox-success" type="checkbox" name="pemeriksaan_bayi_setelah_lahir_anus" id="pemeriksaan_anus">
				...
				<div class="mt-3">
					...
					<div class="d-flex gap-4">
						<div class="form-check">
							<input class="custom-checkbox-success" type="checkbox" name="dibantu_oleh_dokter" id="dibantu_dr">
							<label class="form-check-label" for="dibantu_dr">Dokter</label>
						</div>
						<div class="form-check">
							<input class="custom-checkbox-success" type="checkbox" name="dibantu_oleh_bidan" id="dibantu_bidan">
