                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control border border-dark" name="tgl_admit" disabled>
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                ...
                <tr>
                    <td colspan="2">
                        <div class="form-group">
                            ...
                            <textarea  name="diagnosa_tindakan" class="form-control border-dark" rows="3"></textarea>
                        </div>
                </tr>
                <tr>
                    <td colspan="2">
