...
<table class="table table-bordered border-dark">
    ...
    <tbody class="text-center">
        ...
        <tr>
            ...
            <td><select type="select" name="dasar_diagnosis" id="dasar_diagnosis" class="form-select diagnosa" style="width: 100%;"></td>
        ...
        <tr>
            <td class="bg-light text-center " colspan="4">
                <h5 class="text-black">PENOLAKAN TINDAKAN ANESTESI / SEDASI</h5>
            </td>
        </tr>
        <tr>
            <td colspan="4">
                <div class="d-flex flex-wrap align-items-center gap-3 mb-4">
                    ...
                    <span>, dengan ini menyatakan PENOLAKAN untuk dilakukannya tindakan</span>
