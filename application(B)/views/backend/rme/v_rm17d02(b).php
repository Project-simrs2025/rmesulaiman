                    ...
                    <th class="col-12">
                        ...
                        <table class="table table-borderless border-dark">
                            <div class="d-flex flex-column gap-3">
                                <div>
                                    <img class="marker-image" id="setting_img" src="<?= base_url('assets2/rme/img/pad.png') ?>"
                                ...
                                <div>
                                    <img class="marker-image" id="setting_img" src="<?= base_url('assets2/rme/img/padGrafik.png') ?>"
                                ...
                                <div>
                                    <img class="marker-image" id="setting_img" src="<?= base_url('assets2/rme/img/pad2.png') ?>"
