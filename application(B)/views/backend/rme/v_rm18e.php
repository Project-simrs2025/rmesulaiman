        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <select type="select" name="nama_perawat_pengkaji" class="form-select perawat"
                        style="width: 100%;"></select>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="time" class="w-100 form-control border-dark" value="<?= date('H:i') ?>" name="jam_operasi_dimulai">
                </td>
                <td>
