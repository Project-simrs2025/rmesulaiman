        ...
        <table class="table-bordered border-dark table">
            <tr>
                ...
                <td rowspan="2" colspan="2">
                    <label for="jam_penanganan_dewasa_1">Jam Datang</label>
                    <input type="time" class="form-control border-dark" name="jam_penanganan_dewasa_1" id="jam_penanganan_dewasa_1">
                </td>
                <td colspan="2">
            ...
            <tr>
                ...
                <td colspan="2">
                    <label for="trage_sekunder_dewasa_1">Triage Sekunder</label>
