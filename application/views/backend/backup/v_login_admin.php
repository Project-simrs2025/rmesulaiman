...
<head>
    ...
    <link href="<?php echo base_url('assets2/compiled/css/app-dark.css')?>" rel="stylesheet" type="text/css">
...
<div class="row h-100">
    ...
    <div class="col-lg-5 col-12">
        ...
        <div id="auth-left">
            ...
            <img src="<?php echo base_url().'assets/images/logo/'.$images;?>" alt="Logo" srcset="<?php echo base_url().'assets/images/logo/'.$images;?>" style="width:20%;"/>
            <p class="auth-subtitle mb-5 display-4">Login Admin</p>
            ...
            ?>
                ...
                <div class="row" id="daftarbut">
                    ...
                    <div class="col-md-6">
                        <button class="btn btn-success btn-block btn-lg shadow-lg">Login</button>
                    </div>
                    <?php
                    echo form_close();
                    ?>
    ...
    <script src="<?php echo base_url('assets2/static/js/components/dark.js')?>"></script>
