        ...
        <!------- breadcrumb --------->
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="btn icon btn-sm btn-warning" id="btn-validate-import" onclick="add_person()"><i class="bi bi-plus"></i></a>
...
<script type="text/javascript">
    ...
    {
        document.getElementById(divId).style.display = element.value == 4 ? 'none' : 'block';
    }
</script>
...
function add_person()
{
    ...
    $('.modal-title').text('Tambah User Akun'); // Set Title to Bootstrap modal title bg-success 
    $("#level,#poli").select2({
...
function edit_person(user_id)
{
    ...
    $('.help-block').empty(); // clear error string
    $('#modal_form').modal('show'); // show bootstrap modal
    $('.modal-title').text('Edit User Akun'); // Set title to Bootstrap modal title
