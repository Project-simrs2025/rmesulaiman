...
<head>
	...
	<script language="JavaScript" type="application/javascript" src="<?php echo base_url('assets2/extensions/marker/markerjs2.js')?>"></script>
	<script language="JavaScript" type="application/javascript" src="<?php echo base_url('assets2/extensions/marker/markerjs-live.js')?>"></script>
	<script>
		class MarkerManager {
