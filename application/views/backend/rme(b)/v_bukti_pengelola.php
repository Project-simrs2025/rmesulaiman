    ...
    <table class="table table-bordered border-dark">
        <tbody>
            <tr class="border-bottom-0">
                <td>
                    <div>Lembar I = Bukti Pelayanan</div>
                    <div>Lembar II = arsip R.S</div>
                </td>
            </tr>
            <tr class=" border-top-0">
                <td>
                    <div class="text-center">( Mohon di isi dengan lengkap digunakan sebagai lampiran tagihan R.S)</div>
                    <div class="d-flex justify-content-center align-items-center gap-2 my-3">
                        <label for="" class="col-1">No Register</label>
                        <input type="text" name="no_rm" id="" class="form-control border-dark w-50">
                    </div>
                </td>
            </tr>
        </tbody>
                ...
                <tr class=" ">
                    <td>
                        <div class="row">
                            <div class="col-6">
                                <div class="d-flex flex-column gap-2">
                                    <div class="d-flex align-items-center gap-2 ">
                                        <label for="" class="col-3">Rumah Sakit</label>
                                        <input type="text" name="rs" id="" class="form-control border-dark" value="WIRA HUSADA" disabled>
                                    </div>
                                    <div class="d-flex align-items-center gap-2 ">
                                        <label for="" class="col-3">Kelas RS</label>
                                        <input type="text" name="kelas_rs" id="" class="form-control border-dark" value="'D'" disabled>
                                    </div>

                                    <div class="d-flex align-items-center gap-2 ">
                                        <label for="" class="col-3">Nama Penderita</label>
                                        <input type="text" name="nama_pasien" id="" class="form-control border-dark">
                                    </div>
                                    <div class="d-flex align-items-center gap-2 ">
                                        <label for="" class="col-6">Peserta/Istri/Suami/Anak Ke</label>
                                        <input type="text" name="peserta_ke" id="" class="form-control border-dark">
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="d-flex flex-column gap-2">
                                    <div class="d-flex align-items-center gap-2 ">
                                        <label for="" class="col-3">Kabupate/Kota</label>
                                        <input type="text" name="rs" id="" class="form-control border-dark" value="ASAHAN" disabled>
                                    </div>
                                    <div class="d-flex align-items-center gap-2 ">
                                        <label for="" class="col-3">Provinsi</label>
                                        <input type="text" name="rs" id="" class="form-control border-dark" value="SUMATERA UTARA" disabled>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2 ">
                                        ...
                                        <div class="col-6 d-flex align-items-center gap-2">
                                            <label for="" class="flex-shrink-0">Jenis kelamin</label>
                            ...
                            <div class="mt-3 d-flex align-items-center gap-2">
                                <label for="" class="col-2">Nama Peserta</label>
                                <input type="text" class="form-control border-dark" name="nama_pesert" value="<?= $nama_pasien; ?>" disabled>
                            </div>
                            <div class="mt-3 d-flex align-items-center gap-2">
                                <label for="" class="col-2">Diagnosa</label>
                                <select type="select" name="diagnosa" id="diagnosa" class="form-select diagnosa">
                                </select>
                            </div>
                            <div class="mt-3 fw-bold">PELAYANAN DI RUMAH SAKIT</div>
                        </div>
                    </td>
                </tr>
            </tbody>
    ...
    <table class="table table-bordered border-dark">
        <tbody>
            <tr class="text-center">
                <td rowspan="3">Tanggal Pelayanan</td>
                <td colspan="9">Pelayanan Yang Diberikan</td>
                <td rowspan="3">Keterangan</td>
            </tr>
            <tr class="text-center">
                <td colspan="3">Pemeriksaan</td>
                <td colspan="3">Penunjang Diagnostik</td>
            ...
            ?>
                <tr>
                    <td>
                        <input type="date" name="tgl_pelayanan_pemeriksaan<?= $i; ?>" id="" class="form-control border-dark" style="width:150px;">
                    </td>
                    <td>
                        <textarea name="j_pely_pemeriksaan<?= $i; ?>" id="" class="form-control border-dark" rows="3" style="width:150px;"></textarea>
                    </td>
                    <td>
                        <div class="d-flex justify-content-center my-2">
                            <img class="img-responsive center-block mt-2" style="width: 40%;" id="qr_dokter_pemeriksaan<?= $i; ?>" />
                        </div>
                        <select type="select" name="dokter_pemeriksaan<?= $i; ?>" id="dokter_pemeriksaan<?= $i; ?>" class="form-select dokter_umum" style="width: 200px;"></select>
                    </td>
                    <td>
                        <img class=" marker-image" id="pemeriksaan_img" src="<?= $base_url ?>" style="width: 230px; height:130px" data-input-name="image_drawer_state_image_pemeriksaan_<?= $i ?>" />
                        <input type="hidden" id="image_drawer_state_image_pemeriksaan_<?= $i ?>" name="image_drawer_state_image_pemeriksaan_<?= $i ?>" value="" />
                    </td>


                    <!-- diagnostik -->
                    <td>
                        <textarea name="j_pely_diagnostik<?= $i; ?>" id="" class="form-control border-dark" rows="3" style="width:150px;"></textarea>
                    </td>
                    <td>
                        <div class="d-flex justify-content-center my-2">
                            <img class="img-responsive center-block mt-2" style="width: 40%;" id="qr_dokter_diagnostik<?= $i; ?>" />
                        </div>
                        <select type="select" name="dokter_diagnostik<?= $i; ?>" id="dokter_diagnostik<?= $i; ?>" class="form-select dokter_umum" style="width: 200px;"></select>
                    </td>
                    <td>
                        <img class=" marker-image" id="diagnostik_img" src="<?= $base_url ?>" style="width: 230px; height:130px" data-input-name="image_drawer_state_image_diagnostik_<?= $i ?>" />
                        <input type="hidden" id="image_drawer_state_image_diagnostik_<?= $i ?>" name="image_drawer_state_image_diagnostik_<?= $i ?>" value="" />
                    </td>
                    <!-- end diagnostik -->
                    ...
                    <!-- penunjang -->
                    <td>
                        <textarea name="j_pely_penunjang<?= $i; ?>" id="" class="form-control border-dark" rows="3" style="width:150px;"></textarea>
                    </td>
                    <td>
                        <div class="d-flex justify-content-center my-2">
                            <img class="img-responsive center-block mt-2" style="width: 40%;" id="qr_dokter_penunjang<?= $i; ?>" />
                        </div>
                        <select type="select" name="dokter_penunjang<?= $i; ?>" id="dokter_penunjang<?= $i; ?>" class="form-select dokter_umum" style="width: 200px;"></select>
                    </td>
                    <td>
                        <img class=" marker-image" id="penunjang_img" src="<?= $base_url ?>" style="width: 230px; height:130px" data-input-name="image_drawer_state_image_penunjang_<?= $i ?>" />
                        <input type="hidden" id="image_drawer_state_image_penunjang_<?= $i ?>" name="image_drawer_state_image_penunjang_<?= $i ?>" value="" />
                    </td>
                    <!-- end penunjang -->


                    <td>
                        <textarea name="keterangan<?=$i;?>" id="" rows="3" style="width: 250px;" class="form-control border-dark"></textarea>
                    </td>
                </tr>
            <?php
            }
...
<div class="row mt-3">
    <div class="col-6">
        <div class="form-check d-flex align-items-center gap-2">
            <label for="" class="col-3">Tindakan Lanjut </label>
            <span>:</span><input type="text" name="tindak" id="tindak" class="form-control border-dark " placeholder="Dirawat/Selesai/Dirujuk/Paps">
        </div>
       <!--  <div>
    ...
    <div class="col-6 text-end">
        <div class="my-3"><?= $city_sign; ?></div>
        <div>Dokter IGD</div>
        <div>RS. Wira Husada</div>
        <div class="my-2 text-end">
            <img class="img-responsive center-block mt-2" style="width: 20%;" id="qr_dokter_umum" />
        </div>
        <select type="select" name="dokter_umum" id="dokter_umum" class="form-select dokter_umum text-end my-2" style="width: 200px;"></select>
        <div class="d-flex align-items-center gap-2 justify-content-end">
            <label for="">NIK</label>
            <input type="text" name="nik_dokter" class="form-control border-dark w-50">
        </div>
    </div>
</div>
    ...
    <ol class="form-check my-2">
        ...
        <li>
            <div class="my-2 d-flex align-items-center gap-2">
                ...
                <input type="text" class="form-control border-dark" name="kelas_perawatan">
            </div>
        </li>
        <li>
            <div class="my-2 d-flex align-items-center gap-2">
        ...
        <li>
            <div class="my-2 d-flex align-items-center gap-2">
                ...
                <input type="text" class="form-control border-dark" name="tgl_keluar">
            </div>
        </li>
        <li>
            <div class="my-2 d-flex align-items-center gap-2">
            ...
            <tbody>
                ...
                <?php for ($i = 1; $i <= 8; $i++): ?>
                    <tr>
                        <td class="text-center"><?= $i; ?></td>
                        <td>
                            <select type="select" name="diagnosa_tindakan_<?= $i; ?>" id="diagnosa_tindakan_<?= $i; ?>" class="form-select diagnosa" style="width: 100%;"></select>
                        </td>
                    </tr>
                <?php endfor; ?>
...
<!-- <div class="d-flex justify-content-end flex-column align-items-end">
    <div class="d-flex align-items-center gap-2">
        ...
        <input type="date" name="tgl_city" id="" class="form-control border-dark" value="<?= date('Y-m-d'); ?>">
    </div>
