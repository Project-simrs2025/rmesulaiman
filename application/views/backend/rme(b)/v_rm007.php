...
<div class="row mb-4">
	...
	<div class="col-md-6">
		...
		<div class="mb-3">
			<label for="nama_poli" class="form-label">Ruangan</label>
			<!-- <select type="select" name="nama_poli_ruangan" class="form-select poli">
			</select> -->
			<input type="text" class="form-control border-dark" id="nama_poli" name="nama_poli">
		</div>
		<div class="mb-3">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="form-check">
					<input class="custom-checkbox-success" type="radio" name="pemeriksaan_penunjang" id="laboratorium" value="laboratorium">
					<label class="form-check-label" for="laboratorium">Laboratorium</label>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-check">
					<input class="custom-checkbox-success" type="radio" name="pemeriksaan_penunjang" id="ekg" value="ekg">
					<label class="form-check-label" for="ekg">EKG</label>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-check">
					<input class="custom-checkbox-success" type="radio" name="pemeriksaan_penunjang" id="radiologi" value="radiologi">
					<label class="form-check-label" for="radiologi">Radiologi</label>
				</div>
			</div>
			<div class="col-md-3">
				<input type="radio" class="custom-checkbox-success" name="pemeriksaan_penunjang" id="lain_lain" value="radio_lain-lain">
...
<div class="card mb-2">
	...
	<div class="card-body">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="form-check">
					<input class="custom-checkbox-success" type="radio" name="indikasi_type" id="preventif" value="preventif">
					<label class="form-check-label" for="preventif">Preventif</label>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-check">
					<input class="custom-checkbox-success" type="radio" name="indikasi_type" id="kuratif" value="kuratif">
					<label class="form-check-label" for="kuratif">Kuratif</label>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-check">
					<input class="custom-checkbox-success" type="radio" name="indikasi_type" id="paliatif" value="paliatip">
					<label class="form-check-label" for="paliatif">Paliatif</label>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-check">
					<input class="custom-checkbox-success" type="radio" name="indikasi_type" id="rehabilitatif" value="rehabilitatif">
		...
		<div class="row mb-4">
			...
			<div class="col-md-6">
				...
				<div class="mb-3">
					...
					<select type="select" name="nama_ruangan_<?= $i ?>" class="form-select ruangan">
					</select>
