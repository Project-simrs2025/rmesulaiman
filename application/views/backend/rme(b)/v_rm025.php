<div class="row">
    <table class="table table-bordered border-dark">
        <tbody>
            <tr>
                <td>
                    <h6 class="text-center">Formulir Persetujuan</h6>
                </td>
                <td>
                ...
                <td colspan="2">
                    ...
                    <div class="d-flex flex-column gap-2">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <?php
                            $global_data_array = json_decode($global_data, true);

                            // Ambil field 'jenkel_keluarga', normalisasi ke format option
                            $jk = strtolower(trim($global_data_array['jenkel_keluarga'] ?? ''));
                            $jk = str_replace(' ', '-', $jk); // Contoh: "Laki laki" -> "laki-laki"
                            ?>

                            <select name="jenkel_keluarga" class="form-control border-dark">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <span>:</span>
                            <input type="text" name="hubungan_keluarga" id="" class="form-control border-dark">
                        </div>
                    </div>

                    <div class="mt-3">Dengan ini Menyatakan <span class="fw-bold">PERSETUJUAN</span> untuk dilakukan Pengobatan / Tindakan Berupa</div>

                    <div class="mt-3 flex-column">
                        <?php for ($i = 1; $i <= 5; $i++) : ?>
                            <div class="d-flex align-items-center gap-2">
                                <input type="text" name="input_persetujuan_menyatakan_<?= $i; ?>" class="form-control border-dark">
                            </div>
                        <?php endfor; ?>
                    </div>
                    ...
                    <div class="mt-3">
                        <div class="d-flex align-items-center gap-2 flex-wrap">
                            ...
                            <div>Terhadap Saya/Anak/Orang Tua/Istri/Suami bernama </div>
                            <div class="col-4"><input type="text" name="nama_pasien" id="" class="form-control border-dark w-100"></div>
                            <div>Tanggal lahir</div>
                            <div><input type="text" name="tanggal_lahir" id="" class="form-control border-dark"></div>
                            <div><input type="text" name="jenkel" class="form-control border-dark"></div>
                            <div>alamat</div>
                            <div class="col-5"><input type="text" name="alamat" class="form-control border-dark"></div>
                        ...
                        <div class="row mt-5">
                            <div class="col-4">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <input type="text" name="nama_hub_pasien" id="" class="form-control border-dark" placeholder="masukkan nama Pasien / keluarga">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="d-flex flex-column gap-2">
