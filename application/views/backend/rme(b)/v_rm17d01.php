    ...
    <div class="col-12">
        <table class="table table-bordered border-dark">
            ...
            <tr>
                ...
                <td colspan="3"><select type="select" name="diagnosa_pascabedah" class="form-select diagnosa">
                    </select></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center gap-2">
                        <input type="radio" value="anamnesis_auto" id="anamnesis_auto" name="anamnesis" class="custom-checkbox-success"><label for="anamnesis_auto">Auto </label>
                    </div>
                </td>
                <td colspan="2">
                    <div class="d-flex align-items-center gap-2">
                        <input type="radio" value="anamnesis_allo" id="anamnesis_allo" name="anamnesis" class="custom-checkbox-success"><label for="anamnesis_allo">Allo </label>
                    </div>
                </td>
            </tr>
            <tr>
                <td colspan="4"><textarea name="anamnesis_textarea" id="anamnesis_textarea" rows="5" class="form-control border-dark"></textarea></td>
            </tr>
            <tr>
                <td colspan="2"><b>Pemeriksaan fisik & penunjang</b></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="4"><b>Penilaian Pra Induksi:</b> <input type="text" class="form-control border-dark" style="width: 100%;" name="penilaian_pra_induksi"></td>
            </tr>
        </table>
    </div>
</div>
