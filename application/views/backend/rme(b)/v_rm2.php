...
<div class="row my-3">
    ...
    <table class="table table-bordered border-dark ">
        ...
        <tbody>
            <?php
            // Array data dengan 'name' dan 'value' yang sudah terdefinisi
            $data = [
                "airway" => [
                    [
                        "name" => "airway_input_1",
                        "values" => [
                            ["label" => "Obstruksi jalan Nafas total", "value" => "value_1_1"],
                            ["label" => "Parsial", "value" => "value_1_2"]
                        ]
                    ],
                    [
                        "name" => "airway_input_2",
                        "values" => [
                            ["label" => "Patent", "value" => "value_2_1"]
                        ]
                    ],
                    [
                        "name" => "airway_input_3",
                        "values" => [
                            ["label" => "Patent", "value" => "value_3_1"]
                        ]
                    ],
                    [
                        "name" => "airway_input_4",
                        "values" => [
                            ["label" => "Patent", "value" => "value_4_1"]
                        ]
                    ],
                    [
                        "name" => "airway_input_5",
                        "values" => [
                            ["label" => "Patent", "value" => "value_5_1"]
                        ]
                    ]
                ],
                "breathing" => [
                    [
                        "name" => "breathing_input_1",
                        "values" => [
                            ["label" => "Distress pernafasan berat (contoh : penggunaan berat beberapa otot pernafasan tambahan, retraksi iga berat, sianosis akut)", "value" => "value_1_1"],
                            ["label" => "Respiratory arrest", "value" => "value_1_2"],
                            ["label" => "Hipoventilasi", "value" => "value_1_3"]
                        ]
                    ],
                    [
                        "name" => "breathing_input_2",
                        "values" => [
                            ["label" => "Distress pernafasan sedang (contoh : penggunaan sedang beberapa otot pernafasan tambahan, retraksi iga sedang, kulit pucat)", "value" => "value_2_1"]
                        ]
                    ],
                    [
                        "name" => "breathing_input_3",
                        "values" => [
                            ["label" => "Distress pernafasan ringan (contoh : penggunaan sedang beberapa otot pernafasan tambahan, retraksi iga sedang, kulit merah muda)", "value" => "value_3_1"]
                        ]
                    ],
                    [
                        "name" => "breathing_input_4",
                        "values" => [
                            ["label" => "Tidak ada gangguan", "value" => "value_4_1"]
                        ]
                    ],
                    [
                        "name" => "breathing_input_5",
                        "values" => [
                            ["label" => "Tidak ada gangguan", "value" => "value_5_1"]
                        ]
                    ]
                ],
                "Circulation" => [
                    [
                        "name" => "circulation_input_1",
                        "values" => [
                            ["label" => "Gangungan hemodinamik berat (contoh : tidak teraba nadi perifer, kulit pucat, dingin, lembab, takikardi yang signifikan, waktu pengisian kapiler 4 detik)", "value" => "value_1_1"],
                            ["label" => "Cardiac arrest", "value" => "value_1_2"],
                            ["label" => "Pendarahan tidak terkontrol", "value" => "value_1_3"]
                        ]
                    ],
                    [
                        "name" => "circulation_input_2",
                        "values" => [
                            ["label" => "Gangguan hemodinamik sedang (contoh : nadi perifer teraba lemah/halus, kulit pucat sejuk, takikardi sedang, waktu pengisian kapiler 2-4 detik)", "value" => "value_2_1"],
                            ["label" => "Dehidrasi berat", "value" => "value_2_2"],
                        ]
                    ],
                    [
                        "name" => "circulation_input_3",
                        "values" => [
                            ["label" => "Gangguan hemodinamik ringan (contoh : nadi perifer teraba kuat, kulit pucat hangat, takikardi ringan)", "value" => "value_3_1"],
                            ["label" => "Dehidrasi sedang", "value" => "value_3_2"],
                        ]
                    ],
                    [
                        "name" => "circulation_input_4",
                        "values" => [
                            ["label" => "Tidak ada gangguan", "value" => "value_4_1"],
                            ["label" => "Dehidrasi ringan", "value" => "value_4_2"]
                        ]
                    ],
                    [
                        "name" => "circulation_input_5",
                        "values" => [
                            ["label" => "Tidak ada gangguan", "value" => "value_5_1"]
                        ]
                    ]
                ...
                "Disability" => [
                    [
                        "name" => "disability_input_1",
                        "values" => [
                            ["label" => "GCS < 9", "value" => "value_1_1"],
                        ]
                    ],
                    [
                        "name" => "disability_input_2",
                        "values" => [
                            ["label" => "GCS 9 – 12", "value" => "value_2_1"],
                            ["label" => "Penurunan aktivitas berat (contoh : tidak ada kontak mata, tonus otot menurun)", "value" => "value_2_2"],
                        ]
                    ],
                    [
                        "name" => "disability_input_3",
                        "values" => [
                            ["label" => "GCS 13 – 14", "value" => "value_3_1"],
                            ["label" => "Penurunan aktivitas sedang (contoh : letargi, kontak mata ada bila terganggu)", "value" => "value_3_2"],
                        ]
                    ],
                    [
                        "name" => "disability_input_4",
                        "values" => [
                            ["label" => "GCS normal", "value" => "value_4_1"],
                            ["label" => "Penrunan aktivitas ringan (contoh : ada kontak mata)", "value" => "value_4_2"]
                        ]
                    ],
                    [
                        "name" => "disability_input_5",
                        "values" => [
                            ["label" => "GCS normal", "value" => "value_5_1"]
                        ]
                    ]
                ],
            ];
            ...
            <?php foreach ($data as $section => $radioGroups): ?>
                <tr>
                    <td>
                        <div class="text-uppercase p-2"><?= $section ?></div>
                    </td>

                    <?php foreach ($radioGroups as $radioGroup): ?>
                        <td>
                            <div class="d-flex flex-column p-2 gap-2">
                                <?php foreach ($radioGroup['values'] as $index => $radio): ?>
                                    <div class="d-flex gap-2">
                                        <div>
                                            <!-- Menambahkan id pada input radio -->
                                            <input type="checkbox"
                                                class="custom-checkbox-success"
                                                name="<?= $radioGroup['name'] ?>"
                                                id="<?= $radioGroup['name'] . '_' . $radio['value'] ?>"
                                                value="<?= $radio['value'] ?>">
                                        </div>
                                        <div>
                                            <!-- Menambahkan label for yang sesuai dengan id input -->
                                            <label for="<?= $radioGroup['name'] . '_' . $radio['value'] ?>"><?= $radio['label'] ?></label>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            </div>
    ...
    <table class="border-dark table-bordered">
        <tbody>
                ...
                <td class="p-2" colspan="4">
                    ...
                    <div class="d-flex gap-2 flex-column mt-2">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <div class="col-3 d-flex gap-2">
                                <input type="radio" class="custom-checkbox-success" name="k_edukasi" id="d_mjm" value="d_mjm">
                                <label for="d_mjm">Diagnosa dan manajemen</label>
                            </div>
                            <div class="col-2 d-flex gap-2">
                                <input type="radio" class="custom-checkbox-success" name="k_edukasi" id="d_obat" value="d_obat">
                                <label for="d_obat">Obat-obatan</label>
                            </div>
                            <div class="col-2 d-flex gap-2">
                                <input type="radio" class="custom-checkbox-success" name="k_edukasi" id="p_luka" value="p_luka">
                                <label for="p_luka">Perawatan luka</label>
                            </div>
                            <div class="col-2 d-flex gap-2">
                                <input type="radio" class="custom-checkbox-success" name="k_edukasi" id="p_rehab" value="p_rehab">
                                <label for="p_rehab">Rehabilitasi</label>
                            </div>
                            <div class="col-2 d-flex gap-2">
                                <input type="radio" class="custom-checkbox-success" name="k_edukasi" id="mjm_nyeri" value="mjm_nyeri">
                                <label for="mjm_nyeri">Manajemen nyeri</label>
                            </div>
                            <div class="col-2 d-flex gap-2 align-items-center">
                                <input type="radio" class="custom-checkbox-success" name="k_edukasi" id="d_nutrisi" value="d_nutrisi">
                                <label for="d_nutrisi">Diet dan nutrisi</label>
                            </div>
                            <div class="col-4 d-flex gap-2 align-items-center w-75">
                                <input type="radio" class="custom-checkbox-success" name="k_edukasi" id="d_lain2" value="d_lain2" onclick="toggleOtherInput(true)">
                                <div class="d-flex gap-2 align-items-center w-100">
            ...
            <tr>
                ...
                <td class="p-2" colspan="2">
                    <div class="d-flex flex-column gap-2" style="margin-top:-230px">
                        <?php
                        $care_plan = [
                        ...
                        <td>
                            <div style="width: 300px;">
                                <div class="d-flex align-items-center justify-content-center my-2">
                                    <img class="img-responsive center-block mt-2" style="width: 25%;" id="qr_dokter_umum<?= $i; ?>" />
                                </div>
                    ...
                    <div class="d-flex gap-3">
                        <div class="col-4">
                            <div class="d-flex align-items-center">
                                ...
                                <input type="date" class="form-control border-dark" id="tanggal_input">
                            </div>
                        </div>
...
<div class="row mt-4">
    ...
    <div class="col-6 text-center">
        <div class="my-2">Perawat Yang Melakukan Pengkajian</div>
