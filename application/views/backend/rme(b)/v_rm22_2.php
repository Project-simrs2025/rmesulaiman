...
<table class="table table-borderless border-dark">
    <tr>
        <td>
            <h6 class="fw-bold text-center">FORMULIR PENANDAAN AREA OPERASI (PEREMPUAN)</h6>
        </td>
        <td>
    ...
    <tr>
        <td rowspan="3">
            <p>
                <img class="marker-image" id="example-image" src="<?= base_url('assets2/rme/img/opperempuan.png') ?>" style="width: 600px;height:500px;" data-input-name="image_drawer_state_image_1" />
            ...
            <div class="d-flex justify-content-between mt-4">
                ...
                <div class="col-4">
                    ...
                    <input type="hidden" id="image_drawer_state_image_1_tdd" name="image_drawer_state_image_1_tdd"
                        value="" />
                    <input type="text" class="form-control border-dark" name="nama_pasien_keluarga" value="<?= $nama_hub_pasien; ?>">
                </div>
                <div class="col-4">
