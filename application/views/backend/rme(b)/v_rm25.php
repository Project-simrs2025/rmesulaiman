...
<table class="table table-bordered border-dark">
  ...
  <tr>
    ...
    <td><input type="checkbox" id="TAK" class="custom-checkbox-success" name="TAK" value="" /> <label for="TAK">T.A.K</label></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2"><input type="checkbox" id="TAK2" class="custom-checkbox-success" name="TAK" value="" /> <label for="TAK2">T.A.K</label></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2"><input type="checkbox" id="TAK3" class="custom-checkbox-success" name="TAK" value="" /> <label for="TAK3">T. A. K</label></td>
  </tr>
  <tr>
    ...
    <td colspan="4">
      ...
      <div class="mt-3">
        ...
        <div class="d-flex" style="gap: 15px;">
          <div class="d-flex" style="gap: 10px;"><input type="checkbox" name="masalah_keperawatan_koping_individu_tidak_efektif" class="custom-checkbox-success" id="masalah_keperawatan_koping_individu_tidak_efektif"><label class="form-check-label" for="masalah_keperawatan_koping_individu_tidak_efektif">Koping individu tidak efektif</label></div>
          <div class="d-flex" style="gap: 10px;"><input type="checkbox" name="masalah_keperawatan_distress_spiritual" class="custom-checkbox-success" id="masalah_keperawatan_distress_spiritual"><label class="form-check-label" for="masalah_keperawatan_distress_spiritual">Distress Spiritual</label></div>
        </div>
      </div>
      ...
      <div class="d-flex justify-content-end gap-2">
        ...
        <div class="d-flex flex-column align-items-center gap-2" style="max-width: 300px;">
          <img class="img-responsive center-block " style="width: 50%;" id="qr_perawat" />
          <input type="text" name="nama_perawat_form" id="nama_perawat_form" class="form-control border-dark border-dark">
