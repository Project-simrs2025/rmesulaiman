<div class="container mt-4 d-flex flex-column gap-5">
    ...
    <div class="row">
        <div class="d-flex gap-2 justify-content-end align-items-center my-2"><?= $city_sign; ?>,<input type="date" name="tanggal_2" class="form-control border-dark border-dark w-25"></div>
