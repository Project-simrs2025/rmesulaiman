          ...
          <table class="table table-bordered border-dark text-center">
            <tbody>
              <tr class="inputDerajat">
                ...
                ${[0, 1, 2, 3, 4].map(i => `
                  <td><input type="text" class="form-control border-dark" name="ekg[]" value="${bundleData?.bab?.ekg?.[i] || ''}"></td>
                `).join('')}
              </tr>
              <tr class="inputDerajat">
                <td colspan="2">Saturasi O₂</td>
                ${[0, 1, 2, 3, 4].map(i => `
                  <td><input type="text" class="form-control border-dark" name="saturasi[]" value="${bundleData?.bab?.saturasi?.[i] || ''}"></td>
                `).join('')}
              </tr>
              <tr class="inputDerajat">
                <td colspan="2">GCS</td>
                ${[0, 1, 2, 3, 4].map(i => `
                  <td><input type="text" class="form-control border-dark" name="gcs[]" value="${bundleData?.bab?.gcs?.[i] || ''}"></td>
                `).join('')}
              </tr>
              <tr class="inputDerajat">
                <td colspan="2">Pupil</td>
                ${[0, 1, 2, 3, 4].map(i => `
                  <td><input type="text" class="form-control border-dark" name="pupil[]" value="${bundleData?.bab?.pupil?.[i] || ''}"></td>
                `).join('')}
              </tr>
            </tbody>
          </table>
          ...
          <table class="table table-bordered border-dark text-center">
            <tbody>
              <tr class="inputDerajat">
                ...
                ${[0, 1, 2, 3, 4].map(i => `
                  <td><input type="text" class="form-control border-dark" name="mode[]" value="${bundleData?.bab?.mode?.[i] || ''}"></td>
                `).join('')}
              </tr>
              <tr class="inputDerajat">
                <td colspan="2">PC/PS</td>
                ${[0, 1, 2, 3, 4].map(i => `
                  <td><input type="text" class="form-control border-dark" name="pcps[]" value="${bundleData?.bab?.pcps?.[i] || ''}"></td>
                `).join('')}
              </tr>
              <tr class="inputDerajat">
                <td colspan="2">TV</td>
                ${[0, 1, 2, 3, 4].map(i => `
                  <td><input type="text" class="form-control border-dark" name="tv[]" value="${bundleData?.bab?.tv?.[i] || ''}"></td>
                `).join('')}
              </tr>
              <tr class="inputDerajat">
                <td colspan="2">RR</td>
                ${[0, 1, 2, 3, 4].map(i => `
                  <td><input type="text" class="form-control border-dark" name="rr[]" value="${bundleData?.bab?.rr?.[i] || ''}"></td>
                `).join('')}
              </tr>
              <tr class="inputDerajat">
                <td colspan="2">PEEP</td>
                ${[0, 1, 2, 3, 4].map(i => `
                  <td><input type="text" class="form-control border-dark" name="peep[]" value="${bundleData?.bab?.peep?.[i] || ''}"></td>
                `).join('')}
              </tr>
            </tbody>
          </table>
    ...
    for (let i = 0; i < tanggalArr.length; i++) {
      const hariData = {
        ...
        bab: {
          ...
          ekg: (dataCommon.get("ekg") || []).slice(i * 5, i * 5 + 5),
          saturasi: (dataCommon.get("saturasi") || []).slice(i * 5, i * 5 + 5),
          gcs: (dataCommon.get("gcs") || []).slice(i * 5, i * 5 + 5),
          pupil: (dataCommon.get("pupil") || []).slice(i * 5, i * 5 + 5),
          mode: (dataCommon.get("mode") || []).slice(i * 5, i * 5 + 5),
          pcps: (dataCommon.get("pcps") || []).slice(i * 5, i * 5 + 5),
          tv: (dataCommon.get("tv") || []).slice(i * 5, i * 5 + 5),
          rr: (dataCommon.get("rr") || []).slice(i * 5, i * 5 + 5),
          peep: (dataCommon.get("peep") || []).slice(i * 5, i * 5 + 5),
