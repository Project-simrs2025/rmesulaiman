<div class="row">
    ...
    <div class="d-flex flex-column gap-2 mt-2">
        ...
        <div class="my-2">Bahwa pasien yang dirawat di Rumah Sakit Umum <?= $site_title ?>, yang bernama :</div>
        ...
        <div class="mt-1 d-flex align-items-center gap-2 flex-wrap">Dan Dengan ini saya menyatakan bahwasanya, untuk biaya perawatan/ perobatan selama di Rumah Sakit bersedia membayar dengan tarif UMUM sesuai tarif yang berlaku di <?= $lokasi ?>
        </div>
