        ...
        <table class="table table-bordered border-dark" id="table-resiko">
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control border-dark  border-dark" style="width: 200px;" name="jumlah_mulut[]"></td>
                    <td><input type="text" class="form-control border-dark  border-dark" style="width: 200px;" name="total_mulut[]"></td>
