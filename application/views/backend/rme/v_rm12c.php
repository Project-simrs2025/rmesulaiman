    ...
    <div class="table-responsive">
        <table class="table table-bordered border-dark" id="VisiteProgramTable">
            ...
            <tbody id="table-body">
                ...
                <td><input type="text" name="jenis_cairan[]" id="" class="form-control border-dark" style="width:80px"></td>

                <td><input type="text" name="jumlah[]" id="" class="form-control border-dark" style="width:80px"></td>

                <td><input type="text" name="total[]" id="" class="form-control border-dark" style="width:80px"></td>
