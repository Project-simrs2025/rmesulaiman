           ...
           <table class="table table-bordered border-dark">
				...
				<tr>
					<td colspan="4" align="center">
						<div class="bg-secondary"><h2 class="text-white">PERSETUJUAN TINDAKAN ANESTESI / SEDASI</h2></div>
					</td>
				</tr>
				<tr>
					<td colspan="4">
						...
						<div  class="d-flex align-items-center gap-2">
							<span class="flex-shrink-0">, dengan ini menyatakan persetujuan untuk dilakukannya tindakan</span>
