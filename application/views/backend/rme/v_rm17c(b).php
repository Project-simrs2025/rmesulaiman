<div class="row">
    ...
    foreach ($dataform1 as $a) {
        ...
        echo "<input type='{$a['tipe']}' class='form-control {$a['name']} border-dark' name='{$a['name']}' id='{$a['name']}' placeholder='{$a['holder']}' {$a['status']} >
        </div>";
    }
    ?>
</div>
            ...
            <td>
                <div class="form-group">
                    ...
                    <div class="text-center">
                        <img class="img-responsive center-block " style="width: 10%;" id="qr_perawat" />
                    </div>
                </div>
            </td>
        </tr>
