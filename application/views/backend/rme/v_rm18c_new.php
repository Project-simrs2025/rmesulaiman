    ...
    function addRow() {
        ...
        row1.innerHTML = `
           ...
           <table class="table table-bordered border-dark" cellpadding="4" style="width:100%">
                <tr>
                    <td align="center"><b>FORMULIR PENANDAAN AREA OPERASI (Laki-laki)</b></td>
                    <td> 
           ...
           <table class="table table-borderless">
                ...
                <tr>
                    ...
                    <td colspan="2" rowspan="3">
                        <img id="setting_img" class="marker-image border" src="<?= base_url('assets2/rme/img/oplaki.png') ?>" style="width: 600px;height:500px;" data-input-name="image_drawer_oplaki_${rowCount}" />
						<input type="hidden"  id="image_drawer_oplaki_${rowCount}" name="image_drawer_oplaki_${rowCount}" value="" />
                    </td>
                    <td>
