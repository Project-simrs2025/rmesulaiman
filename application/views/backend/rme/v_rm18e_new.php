...
<script>
    ...
    function addRow() {
        ...
        attachSanitizeEvents(row3);
        attachSanitizeEvents(row4);
        attachSanitizeEvents(row5);
        attachSanitizeEvents(row6);
        attachSanitizeEvents(row7);
        attachSanitizeEvents(row8);
        attachSanitizeEvents(row9);
