        ...
        row1.innerHTML = `
           <td colspan="4">
                <table class="table table-bordered border-dark">
                    <tr>
                        <td class="col-md-6"><div>Nama Pasien</div><input type="text" name="nama_pasien_dirawat[]" class="form-control border-dark" value="<?= $nama_pasien ?>" disabled></td>
                    ...
                    <tr>
                        <td><div>No RM</div><input type="text" name="no_rm_pasien_dirawat[]" class="form-control border-dark" value="<?= $no_rm ?>" disabled></td>
