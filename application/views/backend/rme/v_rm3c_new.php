...
<script>
    ...
    function addRow() {
        ...
        row1.innerHTML = `
           ...
           <td colspan="2">
                ...
                <div class="">
                    <input name="pemberi_informasi_persetujuan[]" class="form-control border-dark">
                </div>
        ...
        row4.innerHTML = `
        <td class="">2</td>
        <td class="">Dasar Diagnosis</td>

        <td align="center">
              <select name="diagnosa_dasar_pertama[]" id="diagnosa_dasar_pertama${rowCount}" class="form-select diagnosa_dasar_pertama" style="width:100%;"></select>
            <input type="hidden" name="diagnosa_dasar_pertama_nama[]" class="diagnosa_dasar_pertama_nama">
        </td>
        ...
        rowTandaTangan2.innerHTML = `
            ...
            <div class="text-center">Tanda tangan nama pasien/keluarga</div>
                <div class="text-center">
                    <img class="marker-image" src="<?= base_url() . './assets/images/form/base-ttd.png' ?>" style="width: 220px; height:120px" data-input-name="image_drawer_disetujui_${rowCount}" />
        ...
        <td colspan="4">
                ...
                <div class="bg-dark text-white text-center"><b>PENOLAKAN TINDAKAN KEDOKTERAN</b></div>
                ...
                <div class="mt-2 d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <label class="flex-shrink-0">saya menyatakan PENOLAKAN dilakukan Tindakan Kedokteran berupa </label>
                    <input type="text" name="penolakan_yang_bertanda_tangan[]" class="form-control border-dark">
                </div>
                ...
                <div class="d-flex align-items-center gap-2 mt-3">
                    ...
                    <div class="text-center">Disetujui oleh Pasien</div>
                        <div class="text-center">
                            <img class="marker-image" src="<?= base_url() . './assets/images/form/base-ttd.png' ?>" style="width: 220px; height:120px" data-input-name="image_drawer_setuju_pasien_${rowCount}" />
                    ...
                    <div class="text-center">Saksi Wali/ Keluarga</div>
                        <div class="text-center">
                            <img class="marker-image" src="<?= base_url() . './assets/images/form/base-ttd.png' ?>" style="width: 220px; height:120px" data-input-name="image_drawer_saksi_${rowCount}" />
        ...
        initSelect2Diagnosa('diagnosa_dasar_pertama', 'diagnosa_dasar_pertama');
    ...
    function cbCommon(data) {
        ...
        for (let i = 0; i < rowCount; i++) {
            ...
            const PemberiInformasiPertama = dataObj['pemberi_informasi_persetujuan']?.[i] || '';
            ...
            const SetujuBertandaTangan = dataObj['penolakan_yang_bertanda_tangan']?.[i] || '';
            // batas
            ...
            const diagnosaDasarPertama = dataObj['diagnosa_dasar_pertama_nama']?.[i] || '';
            const diagnosaDasar_idPertama = dataObj['diagnosa_dasar_pertama']?.[i] || '';
            // batas
            ...
            rows[0].querySelector('input[name="pemberi_informasi_persetujuan[]"]').value = PemberiInformasiPertama;
            ...
            rows[15].querySelector('input[name="penolakan_yang_bertanda_tangan[]"]').value = SetujuBertandaTangan;
            ...
            const rowdiagnosaDasar = rows[3];

            initSelect2Diagnosa(
                $(rowdiagnosaDasar).find('.diagnosa_dasar_pertama'),
                rowdiagnosaDasar.querySelector('.diagnosa_dasar_pertama_nama'),
                diagnosaDasarPertama,
                diagnosaDasar_idPertama
            );
