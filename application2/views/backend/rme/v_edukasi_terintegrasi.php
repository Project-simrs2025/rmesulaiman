        ...
        <table class="table table-bordered border-dark">
            <tbody>
                    ...
                    <td>
                        <ol>
                            <div class="d-flex gap-2 flex-column">
                                ...
                                <div class="flex align-items-start gap-2">
                                    <input type="checkbox" name="pelaksanaan_rujuk" id="pelaksanaan_rujuk" class="custom-checkbox-success">
                                    <label class="col-10" for="pelaksanaan_rujuk">Perncanaan pemulangan pasien (rencana pemulangan kompleks/ Dircharge planning)</label>
                                </div>
                            </div>
                        </ol>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <input type="checkbox" name="teknik_re" id="teknik_re" class="custom-checkbox-success">
                            <label for="teknik_re">Teknik Rehabilitasi</label>
                        </div>
                    </td>
                    <td>
                    ...
                    <td>
                        <ol>
                            <div class="d-flex flex-column gap-2">
                                ...
                                <div class="d-flex align-items-start gap-2">
                                    <input type="checkbox" name="makanan_hindari" id="makanan_hindari" class="custom-checkbox-success">
                                    <label class="col-10" for="makanan_hindari"> Makanan yang harus dihindari</label>
                                </div>
                                <div class="d-flex align-items-start gap-2">
