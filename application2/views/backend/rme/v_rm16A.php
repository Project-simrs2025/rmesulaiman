                    ...
                    <table class="table table-bordered border-dark">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <label class="form-check-label" for="djj_1">
                                            < 60 x /menit</label>
                                    <div class="form-check">
                                        <label class="form-check-label" for="djj_0"></label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check">
                                ...
                                <td>
                                    <div class="form-check">
                                        <label class="form-check-label" for="djj_2"> > 80 x / menit</label>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check">
                                        <label class="form-check-label" for="pernafasan_0">tidak ada</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check">
                                        <label class="form-check-label" for="pernafasan_1">Retraksi ringan</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check">
                                        <label class="form-check-label" for="pernafasan_2">Retraksi Berat</label>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check">
                                        <label class="form-check-label" for="tonun_otot_0">sianosis</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check">
                                        <label class="form-check-label" for="tonun_otot_1">hilang dengan O2</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check">
                                        <label class="form-check-label" for="tonun_otot_2">menetap dengan O2</label>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check">
                                        <label class="form-check-label" for="refleks_0">Ada</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check">
                                        <label class="form-check-label" for="refleks_1">Menurun</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check">
                                        <label class="form-check-label" for="refleks_2">Tidak terdengar</label>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check">
                                        <label class="form-check-label" for="warna_0">Tidak Ada</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check">
                                        <label class="form-check-label" for="warna_1">Terdengar dengan steteskop</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check">
                                        <label class="form-check-label" for="warna_2">Terdengar tanpa alat bantu</label>
                                    </div>
                                </td>
                                <td>
            ...
            <div class="d-flex justify-content-evenly">
                ...
                <div class="d-flex flex-column" style="gap: 20px; max-width: 400px;">
                    ...
                    <div class="d-flex flex-column align-items-center gap-2">
                        <img class="img-responsive center-block mt-2" style="width: 20%;" id="qr_perawat_bidan_pengkaji" />
                        <select type="select" name="perawat_pengkaji" id="perawat_bidan_pengkaji" class="form-select perawat"
                        style="width: 75%;"></select>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function cbCommon(data) {
        ...
        $('#perawat_bidan_pengkaji').prop('disabled', false)
        $('#perawat_bidan_pengkaji').select2('open')
        $('#perawat_bidan_pengkaji').select2('close')
        if (mode === "lihat")
            $('#perawat_bidan_pengkaji').prop('disabled', true)



        setTimeout(() => {
            dataDokter?.map(v => {
                if (v.text === $('#perawat_bidan_pengkaji').select2('data')[0].text) {
                    QRSignatureAPI(v.id_original, 'qr_perawat_bidan_pengkaji')
                }
            })
        }, 500)
    }
    ...
    $(document).ready(function() {
        ...
        $('#perawat_bidan_pengkaji').on('select2:select', function(e) {
            const {
                id_original
            } = e.params.data;
            QRSignatureAPI(id_original, 'qr_perawat_bidan_pengkaji')
        });
    })
