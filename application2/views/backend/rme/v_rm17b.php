    ...
    <div class="col-12">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <ol>
                    <li>
                        <select type="select" name="diagnosis_1" id="diagnosis_1" class="form-select diagnosa" style="width: 100%;"></select>
                    </li>
                    <li>
                        <select type="select" name="diagnosis_2" id="diagnosis_2" class="form-select diagnosa" style="width: 100%;"></select>
                    </li>
                </ol>
            </div>
            <div class="col-md-6">
        ...
        <div class="d-flex justify-content-end flex-column align-items-end gap-2">
            ...
            <select type="select" name="dokter_umum" id="dokter_umum" class="form-select dokter" style="width: 35%;"></select>
