<table class="table table-collapse table-bordered border-dark">
    ...
    <tr>
        <td>Pernafasan</td>
        <td colspan="2">
            <input type="checkbox" class="custom-checkbox-success" name="pernafasan_spontan" value="spontan"> Spontan
            <input type="checkbox" class="custom-checkbox-success" name="pernafasan_dibantu" value="dibantu"> Dibantu
        </td>
    </tr>
    <tr>
        <td>Bila spontan</td>
        <td colspan="2">
            <input type="checkbox" class="custom-checkbox-success" name="bila_spontana_adekuat" value="adekuat_bersuara"> Adekuat bersuara
            <input type="checkbox" class="custom-checkbox-success" name="bila_spontan_penyumbatan" value="penyumbatan"> Penyumbatan
            <input type="checkbox" class="custom-checkbox-success" name="bila_spontan_membutuhkan_alat" value="membutuhkan_alat"> Membutuhkan bantuan alat
        </td>
    </tr>
    <tr>
        <td>Kesadaran</td>
        <td colspan="2">
            <div class="d-flex gap-2 align-items-center">
                <input type="checkbox" class="custom-checkbox-success" name="kesadaran_sadar_betul" value="sadar_betul" id="sadar_betul"> <label for="sadar_betul">Sadar betul</label>
                <input type="checkbox" class="custom-checkbox-success" name="kesadaran_belum_sadar_betul" value="belum_sadar_betul" id="belum_sadar_betul"> <label for="belum_sadar_betul">Belum Sadar Betul</label>
                <input type="checkbox" class="custom-checkbox-success" name="kesadaran_tidur_dalam" value="tidur_dalam" id="tidur_dalam"><label for="tidur_dalam">Tidur Dalam</label>
...
<table class="table table-bordered border-dark">
    <tbody>
        <tr>
            <img class="marker-image" id="setting_img" src="<?= base_url('assets2/rme/img/kamar_pemulihan.png') ?>"
                style="width:100%; height:500px;" data-input-name="image_drawer_state_image_kamar_pemulihan" />
            <input type="hidden" id="image_drawer_state_image_kamar_pemulihan" name="image_drawer_state_image_kamar_pemulihan"
                value="" />
        </tr>
    </tbody>
</table>
