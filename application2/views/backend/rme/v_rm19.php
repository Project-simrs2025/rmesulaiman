            ...
            <table class="table table-bordered mt-3 border-dark">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div style="width: 250px;">
                                <div>
                                    ...
                                    <div><input type="checkbox" id="diskusi1" name="diskusi" class="custom-checkbox-success me-2"><label for="diskusi1">Diskusi</label></div>
                                    <div><input type="checkbox" id="demonstrasi1" name="demonstrasi" class="custom-checkbox-success me-2"><label for="demonstrasi1">Demonstrasi</label></div>
                                    <div><input type="checkbox" id="ceramah1" name="ceramah" class="custom-checkbox-success me-2"><label for="ceramah1">Ceramah</label></div>
                                    <div><input type="checkbox" id="observasi1" name="observasi" class="custom-checkbox-success me-2"><label for="observasi1">Observasi</label></div>
                                    <div><input type="checkbox" id="lain1" name="lain" class="custom-checkbox-success me-2"><label for="lain1">lain-lain</label>
                        ...
                        <td>
                            <div style="width: 250px;">
                                <div><input type="checkbox" id="mampu_mengerti1" name="mampu_mengerti" class="custom-checkbox-success me-1"><label for="mampu_mengerti1">Mampu mengerti</label></div>
                                <div class="d-flex flex-start"><input type="checkbox" id="mampu_memahami1" name="mampu_memahami" class="custom-checkbox-success me-1"><label for="mampu_memahami1" class="col-10">Mampu memahami</label></div>
                                <div><input type="checkbox" id="lain_lain1" name="lain_lain" class="custom-checkbox-success me-1"><label for="lain_lain1">lain-lain</label>
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                ...
                                <div><input type="checkbox" id="diskusi2" name="diskusi2" class="custom-checkbox-success me-2"><label for="diskusi2">Diskusi</label></div>
                                <div><input type="checkbox" id="demonstrasi2" name="demonstrasi2" class="custom-checkbox-success me-2"><label for="demonstrasi2">Demonstrasi</label></div>
                                <div><input type="checkbox" id="ceramah2" name="ceramah2" class="custom-checkbox-success me-2"><label for="ceramah2">Ceramah</label></div>
                                <div><input type="checkbox" id="observasi2" name="observasi2" class="custom-checkbox-success me-2"><label for="observasi2">Observasi</label></div>
                                <div><input type="checkbox" id="lain2" name="lain2" class="custom-checkbox-success me-2"><label for="lain2">lain-lain</label>
                                    <input type="text" name="metode_lain2" id="metode_lain2" class="form-control border-dark">
                                </div>
                            </div>
                        </td>
                        <td>
                            <div><input type="checkbox" id="mampu_mengerti2" name="mampu_mengerti2" class="custom-checkbox-success me-1"><label for="mampu_mengerti2">Mampu mengerti</label></div>
                            <div class="d-flex flex-start"><input type="checkbox" id="mampu_memahami2" name="mampu_memahami2" class="custom-checkbox-success me-1"><label for="mampu_memahami2" class="col-10">Mampu memahami</label></div>
                            <div><input type="checkbox" id="lain_lain2" name="lain_lain2" class="custom-checkbox-success me-1"><label for="lain_lain2">lain-lain</label>
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                ...
                                <div><input type="checkbox" id="diskusi3" name="diskudiskusi3i" class="custom-checkbox-success me-2"><label for="diskusi3">Diskusi</label></div>
                                <div><input type="checkbox" id="demonstrasi3" name="demonstrasi3" class="custom-checkbox-success me-2"><label for="demonstrasi3">Demonstrasi</label></div>
                                <div><input type="checkbox" id="ceramah3" name="ceramah3" class="custom-checkbox-success me-2"><label for="ceramah3">Ceramah</label></div>
                                <div><input type="checkbox" id="observasi3" name="observasi3" class="custom-checkbox-success me-2"><label for="observasi3">Observasi</label></div>
                                <div><input type="checkbox" id="lain3" name="lain3" class="custom-checkbox-success me-2"><label for="lain3">lain-lain</label>
                                    <input type="text" name="metode_lain3" id="metode_lain3" class="form-control border-dark">
                                </div>
                            </div>
                        </td>
                        <td>
                            <div><input type="checkbox" id="mampu_mengerti3" name="mampu_mengerti3" class="custom-checkbox-success me-1"><label for="mampu_mengerti3">Mampu mengerti</label></div>
                            <div class="d-flex flex-start"><input type="checkbox" id="mampu_memahami3" name="mampu_memahami3" class="custom-checkbox-success me-1"><label for="mampu_memahami3" class="col-10">Mampu memahami</label></div>
                            <div><input type="checkbox" id="lain_lain3" name="lain_lain3" class="custom-checkbox-success me-1"><label for="lain_lain3">lain-lain</label>
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                ...
                                <div><input type="checkbox" id="diskusi4" name="diskusi4" class="custom-checkbox-success me-2"><label for="diskusi4">Diskusi</label></div>
                                <div><input type="checkbox" id="demonstrasi4" name="demonstrasi4" class="custom-checkbox-success me-2"><label for="demonstrasi4">Demonstrasi</label></div>
                                <div><input type="checkbox" id="ceramah4" name="ceramah4" class="custom-checkbox-success me-2"><label for="ceramah4">Ceramah</label></div>
                                <div><input type="checkbox" id="observasi4" name="observasi4" class="custom-checkbox-success me-2"><label for="observasi4">Observasi</label></div>
                                <div><input type="checkbox" id="lain4" name="lain4" class="custom-checkbox-success me-2"><label for="lain4">lain-lain</label>
                                    <input type="text" name="metode_lain4" id="metode_lain4" class="form-control border-dark">
                                </div>
                            </div>
                        </td>
                        <td>
                            <div><input type="checkbox" id="mampu_mengerti4" name="mampu_mengerti4" class="custom-checkbox-success me-1"><label for="mampu_mengerti4">Mampu mengerti</label></div>
                            <div class="d-flex flex-start"><input type="checkbox" id="mampu_memahami4" name="mampu_memahami4" class="custom-checkbox-success me-1"><label for="mampu_memahami4" class="col-10">Mampu memahami</label></div>
                            <div><input type="checkbox" id="lain_lain4" name="lain_lain4" class="custom-checkbox-success me-1"><label for="lain_lain4">lain-lain</label>
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                ...
                                <div><input type="checkbox" id="diskusi5" name="diskusi5" class="custom-checkbox-success me-2"><label for="diskusi5">Diskusi</label></div>
                                <div><input type="checkbox" id="demonstrasi5" name="demonstrasi5" class="custom-checkbox-success me-2"><label for="demonstrasi5">Demonstrasi</label></div>
                                <div><input type="checkbox" id="ceramah5" name="ceramah5" class="custom-checkbox-success me-2"><label for="ceramah5">Ceramah</label></div>
                                <div><input type="checkbox" id="observasi5" name="observasi" class="custom-checkbox-success me-2"><label for="observasi5">Observasi</label></div>
                                <div><input type="checkbox" id="lain5" name="lain5" class="custom-checkbox-success me-2"><label for="lain5">lain-lain</label>
                                    <input type="text" name="metode_lain5" id="metode_lain5" class="form-control border-dark">
                                </div>
                            </div>
                        </td>
                        <td>
                            <div><input type="checkbox" id="mampu_mengerti5" name="mampu_mengerti5" class="custom-checkbox-success me-1"><label for="mampu_mengerti5">Mampu mengerti</label></div>
                            <div class="d-flex flex-start"><input type="checkbox" id="mampu_memahami5" name="mampu_memahami5" class="custom-checkbox-success me-1"><label for="mampu_memahami5" class="col-10">Mampu memahami</label></div>
                            <div><input type="checkbox" id="lain_lain5" name="lain_lain5" class="custom-checkbox-success me-1"><label for="lain_lain5">lain-lain</label>
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                ...
                                <div><input type="checkbox" id="diskusi6" name="diskusi6" class="custom-checkbox-success me-2"><label for="diskusi6">Diskusi</label></div>
                                <div><input type="checkbox" id="demonstrasi6" name="demonstrasi6" class="custom-checkbox-success me-2"><label for="demonstrasi6">Demonstrasi</label></div>
                                <div><input type="checkbox" id="ceramah6" name="ceramah6" class="custom-checkbox-success me-2"><label for="ceramah6">Ceramah</label></div>
                                <div><input type="checkbox" id="observasi6" name="observasi6" class="custom-checkbox-success me-2"><label for="observasi6">Observasi</label></div>
                                <div><input type="checkbox" id="lain6" name="lain6" class="custom-checkbox-success me-2"><label for="lain6">lain-lain</label>
                                    <input type="text" name="metode_lain6" id="metode_lain6" class="form-control border-dark">
                                </div>
                            </div>
                        </td>
                        <td>
                            <div><input type="checkbox" id="mampu_mengerti6" name="mampu_mengerti6" class="custom-checkbox-success me-1"><label for="mampu_mengerti6">Mampu mengerti</label></div>
                            <div class="d-flex flex-start"><input type="checkbox" id="mampu_memahami6" name="mampu_memahami6" class="custom-checkbox-success me-1"><label for="mampu_memahami6" class="col-10">Mampu memahami</label></div>
                            <div><input type="checkbox" id="lain_lain6" name="lain_lain6" class="custom-checkbox-success me-1"><label for="lain_lain6">lain-lain</label>
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                ...
                                <div><input type="checkbox" id="diskusi7" name="diskusi7" class="custom-checkbox-success me-2"><label for="diskusi7">Diskusi</label></div>
                                <div><input type="checkbox" id="demonstrasi7" name="demonstrasi7" class="custom-checkbox-success me-2"><label for="demonstrasi7">Demonstrasi</label></div>
                                <div><input type="checkbox" id="ceramah7" name="ceramah7" class="custom-checkbox-success me-2"><label for="ceramah7">Ceramah</label></div>
                                <div><input type="checkbox" id="observasi7" name="observasi7" class="custom-checkbox-success me-2"><label for="observasi7">Observasi</label></div>
                                <div><input type="checkbox" id="lain7" name="lain7" class="custom-checkbox-success me-2"><label for="lain7">lain-lain</label>
                                    <input type="text" name="metode_lain7" id="metode_lain7" class="form-control border-dark">
                                </div>
                            </div>
                        </td>
                        <td>
                            <div><input type="checkbox" id="mampu_mengerti7" name="mampu_mengerti7" class="custom-checkbox-success me-1"><label for="mampu_mengerti7">Mampu mengerti</label></div>
                            <div class="d-flex flex-start"><input type="checkbox" id="mampu_memahami7" name="mampu_memahami7" class="custom-checkbox-success me-1"><label for="mampu_memahami7" class="col-10">Mampu memahami</label></div>
                            <div><input type="checkbox" id="lain_lain7" name="lain_lain7" class="custom-checkbox-success me-1"><label for="lain_lain7">lain-lain</label>
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                ...
                                <div><input type="checkbox" id="diskusi8" name="diskusi8" class="custom-checkbox-success me-2"><label for="diskusi8">Diskusi</label></div>
                                <div><input type="checkbox" id="demonstrasi8" name="demonstrasi8" class="custom-checkbox-success me-2"><label for="demonstrasi8">Demonstrasi</label></div>
                                <div><input type="checkbox" id="ceramah8" name="ceramah8" class="custom-checkbox-success me-2"><label for="ceramah8">Ceramah</label></div>
                                <div><input type="checkbox" id="observasi8" name="observasi8" class="custom-checkbox-success me-2"><label for="observasi8">Observasi</label></div>
                                <div><input type="checkbox" id="lain8" name="lain8" class="custom-checkbox-success me-2"><label for="lain8">lain-lain</label>
                                    <input type="text" name="metode_lain8" id="metode_lain8" class="form-control border-dark">
                                </div>
                            </div>
                        </td>
                        <td>
                            <div><input type="checkbox" id="mampu_mengerti8" name="mampu_mengerti8" class="custom-checkbox-success me-1"><label for="mampu_mengerti8">Mampu mengerti</label></div>
                            <div class="d-flex flex-start"><input type="checkbox" id="mampu_memahami8" name="mampu_memahami8" class="custom-checkbox-success me-1"><label for="mampu_memahami8" class="col-10">Mampu memahami</label></div>
                            <div><input type="checkbox" id="lain_lain8" name="lain_lain8" class="custom-checkbox-success me-1"><label for="lain_lain8">lain-lain</label>
                    ...
                    <?php for($i=9; $i<= 12; $i++) : ?>
                        ...
                        <td>
                            <div>
                                <textarea name="input_lain<?= $i; ?>" rows="7" class="w-100 form-control border-dark"></textarea>

                            </div>
                        </td>
                        <td><input type="date" name="tanggal<?= $i?>" id="tanggal<?= $i?>" class="form-control border-dark"></td>
                        <td>
                            <div>
                                <div class="d-flex gap-2 align-items-center">
                                    <label for="durasi<?= $i?>">Durasi</label>
                                    <input type="text" name="durasi<?= $i?>" id="durasi9" class="form-control w-90 border-dark"> mnt
                                </div>
                                <div><input type="checkbox" id="diskusi<?= $i ?>" name="diskusi<?= $i ?>" class="custom-checkbox-success me-2"><label for="diskusi<?= $i ?>">Diskusi</label></div>
                                <div><input type="checkbox" id="demonstrasi<?= $i ?>" name="demonstrasi<?= $i ?>" class="custom-checkbox-success me-2"><label for="demonstrasi<?= $i ?>">Demonstrasi</label></div>
                                <div><input type="checkbox" id="ceramah<?= $i ?>" name="ceramah<?= $i ?>" class="custom-checkbox-success me-2"><label for="ceramah<?= $i ?>">Ceramah</label></div>
                                <div><input type="checkbox" id="observasi<?= $i ?>" name="observasi<?= $i ?>" class="custom-checkbox-success me-2"><label for="observasi<?= $i ?>">Observasi</label></div>
                                <div><input type="checkbox" id="lain<?= $i ?>" name="lain<?= $i ?>" class="custom-checkbox-success me-2"><label for="lain<?= $i ?>">lain-lain</label>
                                    <input type="text" name="metode_lain<?= $i ?>" id="metode_lain<?= $i ?>" class="form-control border-dark">
                                </div>
                            </div>
                        </td>
                        <td>
                            <div><input type="checkbox" id="mampu_mengerti<?= $i ?>" name="mampu_mengerti<?= $i ?>" class="custom-checkbox-success me-1"><label for="mampu_mengerti<?= $i ?>">Mampu mengerti</label></div>
                            <div class="d-flex flex-start"><input type="checkbox" id="mampu_memahami<?= $i ?>" name="mampu_memahami<?= $i ?>" class="custom-checkbox-success me-1"><label for="mampu_memahami<?= $i ?>" class="col-10">Mampu memahami</label></div>
                            <div><input type="checkbox" id="lain_lain<?= $i ?>" name="lain_lain<?= $i ?>" class="custom-checkbox-success me-1"><label for="lain_lain<?= $i ?>">lain-lain</label>
                                <input type="text" name="evaluasi_lain<?= $i ?>" id="evaluasi_lain<?= $i ?>" class="form-control border-dark">
                            </div>
                        </td>
                        <td>
                            <div class="my-2 text-center" style="width: 180px;">
                                <img class="marker-image border border-dark" id="example-image" src="<?= base_url('assets2/rme/img/testttd.png') ?>"
                                    style="width: 150px; height:100px" data-input-name="image_drawer_state_image_persetujuan_<?= $i ?>" />
                                <input type="hidden" id="image_drawer_state_image_persetujuan_<?= $i ?>" name="image_drawer_state_image_persetujuan_<?= $i ?>"
                                    value="" />
                            </div>
                            <textarea name="nama_hub_pasien_ttd_<?= $i ?>" class="form-control border-dark" rows="2"><?= $nama_hub_pasien; ?></textarea>
                        </td>
                        <td>
                            <div class="text-center my-2">
                                <img class="img-responsive center-block mt-2" style="width: 20%;" id="qr_edukator_<?= $i ?>" />
                            </div>
                            <select type="select" name="edukator_<?= $i ?>" id="edukator_<?= $i ?>" class="form-select perawat" style="width: 250px;"></select>
                        </td>
                    </tr>
                    <?php endfor; ?>
