            ...
            <tr>
                ...
                <td>
                    <div class="d-flex gap-2 p-2 align-items-center">
                        ...
                        <input type="time" class="form-control border-dark me-2" name="waktu">WIB
                    </div>
                </td>
                <td>
                    <div class="d-flex gap-2 p-2  align-items-center">
    ...
    <table class="table-bordered border-dark">
        ...
        <tr>
            <td class="p-2" colspan="2">
                ...
                <div class="my-2 d-flex align-items-center gap-1">
                    <div class="col-md-6">
                        <div class="d-flex align-items-center gap-2">
                        <textarea name="intruksi_tindakan_lanjut" id="" rows="4" class="form-control border-dark w-50"></textarea>

                        <textarea name="intruksi_tindakan_lanjut_xz" id="" rows="4" class="form-control border-dark w-50"></textarea>
                        </div>
                    </div>
                    <div class="col-md-6 ms-4">
                        <div class="d-flex align-items-center gap-2 gap-2">
                            <div class="col-md-6">
                                <div class="d-flex gap-2">
                                    <input type="date" name="tanggal_dokter_umum" class="form-control border-dark" style="width:135px;">
                                    <input type="time" name="waktu_dokter_umum" class="form-control border-dark" style="width:100px;">
                                    <!-- <input type="time" name="time_dokter_umum" class="form-control border-dark" style="width:100px;"> -->
                                </div>
                                <label class="my-2">Dokter Umum</label><br>
                                <select type="select" name="dokter_umum_1" id="dokter_umum_1" class="form-select dokter_umum w-75"></select>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex gap-2">
                                <input type="date" name="tanggal_dokter_dpjp" class="form-control border-dark" style="width:135px;">
                                 <input type="time" name="waktu_dokter_dpjp" class="form-control border-dark" style="width:100px;">
                                </div>
                                <label class="my-2">Dokter DPJP</label> <br>
                                <select type="select" name="dokter_umum_2" id="dokter_umum_2" class="form-select dokter_umum w-75"></select>
                            </div>
            ...
            <tr>
                ...
                <td class="p-2">
                    <div class="d-flex gap-2 flex-column">
                        <div class="d-flex gap-2">
                            <input type="checkbox" class="custom-checkbox-success" name="score_1" id="score_1_1">
                            <label for="score_1_1">≥ 2 (beresiko malnutrisi)</label>
                        </div>
                        <div class="d-flex gap-2">
                            <input type="checkbox" class="custom-checkbox-success" name="score_2" id="score_1_2">
                            <label for="score_1_2">
                ...
                <td class="p-2">
                    <div class="d-flex gap-2 flex-column">
                        <div class="d-flex gap-2">
                            <input type="checkbox" class="custom-checkbox-success" name="score_3" id="score_2_1">
                            <label for="score_2_1">≥ 2 (beresiko malnutrisi)</label>
                        </div>
                        <div class="d-flex gap-2">
                            <input type="checkbox" class="custom-checkbox-success" name="score_4" id="score_2_2" value="< 2 (tidak beresiko malnutrisi)">
                            <label for="score_2_2">
                ...
                <td class="p-2">
                    <div class="d-flex gap-2 flex-column">
                        <div class="d-flex gap-2">
                            <input type="checkbox" class="custom-checkbox-success" name="score_5" id="score_3_1">
                            <label for="score_3_1">≥ 2 (resiko tinggi)</label>
                        </div>
                        <div class="d-flex gap-2">
                            <input type="checkbox" class="custom-checkbox-success" name="score_6" id="score_3_2">
                            <label for="score_3_2">1 (resiko sedang)</label>
                        </div>
                        <div class="d-flex gap-2">
                            <input type="checkbox" class="custom-checkbox-success" name="score_7" id="score_3_3">
        ...
        <table class="table table-bordered border-dark">
            <tbody>
                ...
                <tr>
                    ...
                    for ($i = 1; $i <= 6; $i++) {
                    ?>
                        <td><input type="text" class="form-control border-dark" name="input_<?= $i; ?>_kondisi_umum"></td>
                    <?php
                    }
                    ?>
                </tr>
                ...
                <tr>
                    ...
                    for ($i = 1; $i <= 6; $i++) {
                    ?>
                        <td><textarea name="td_denyut_<?= $i; ?>" id="td_denyut" class="form-control border-dark" rows="4"></textarea></td>
                    <?php
                    }
                    ?>
                </tr>
                ...
                <tr>
                    ...
                    for ($i = 1; $i <= 6; $i++) {
                    ?>
                        <td><textarea name="catatan_penting_<?= $i; ?>" id="" class="form-control border-dark" rows="4"></textarea></td>
                    <?php
                    }
                    ?>
                </tr>
    ...
    <table class="table-bordered border-dark">
        ...
        <tbody>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="d-flex flex-column gap-3">
                                ...
                                <div class="d-flex gap-2 align-items-center w-100">
                                    <input type="checkbox" class="custom-checkbox-success"  id="o2Portabel" name="o2Portabel">
                                    <div class="d-flex align-items-center w-100">
                                        <label for="o2Portabel" class="col-4">O2 Portabel, Kebutuhan :</label>
                                        <input type="text" class="form-control border-dark" id="o2Input" name="o2_kebutuhan"> L/menit
                                    </div>
                                </div>

                                <!-- NGT -->
                                <div class="d-flex gap-2 align-items-center">
                                    <input type="checkbox" class="custom-checkbox-success"  id="ngt" name="ngt_portabel">
                                    <label for="ngt" class="col-4">NGT</label>
                                </div>

                                <!-- Ventilator -->
                                <div class="d-flex gap-2 align-items-center">
                                    <input type="checkbox" class="custom-checkbox-success"  id="ventilator" name="ventilator_portabel" >
                                    <label for="ventilator" class="col-4">Ventilator</label>
                                </div>

                                <!-- DLL -->
                                <div class="d-flex gap-2 align-items-center w-100">
                                    <input type="checkbox" class="custom-checkbox-success"  id="dll" name="dll">
                                    <div class="d-flex align-items-center w-100">
                                        <label for="dll" class="col-4">DLL</label>
                                        <input type="text" class="form-control border-dark" id="dllInput" name="dll_kebutuhan">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="d-flex flex-column gap-3">
                                ...
                                <!-- Suction -->
                                <div class="d-flex gap-2 align-items-center">
                                    <input type="checkbox" class="custom-checkbox-success"  id="suction" name="suction">
                                    <label for="suction" class="col-4">Suction</label>
                                </div>

                                <!-- Infus -->
                                <div class="d-flex gap-2 align-items-center">
                                    <input type="checkbox" class="custom-checkbox-success"  id="infus" name="infus">
                                    <label for="infus" class="col-4">Infus</label>
                                </div>

                                <!-- Kateter Urine -->
                                <div class="d-flex gap-2 align-items-center">
                                    <input type="checkbox" class="custom-checkbox-success"  id="kateterUrine" name="kateterUrine">
            ...
            <tr>
                <td class="p-2">
                    <div class="d-flex align-items-center gap-2">
                        <input type="radio" class="custom-checkbox-success" name="tindak_rujuk_nama_rs" value="rujuk_rumah_sakit" id="rujuk_rumah_sakit">
                        <div class="d-flex align-items-center w-100">
            ...
            <tr>
                <td class="p-2">
                    <div class="d-flex align-items-center gap-2">
                        <input type="radio" class="custom-checkbox-success" name="tindak_rujuk_rs_pulang" value="dipulangkan" id="dipulangkan">
...
<div class="row my-3">
    <div class="d-flex justify-content-end align-items-center">
        <span class="me-2"><?= $city_sign ?>, </span> <input type="date" name="tanggal_2" class="form-control border-dark w-25" >
    </div>
</div>
