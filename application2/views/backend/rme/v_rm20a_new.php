                ...
                <thead class="table-bordered border-dark">
                    <tr>
                        <td colspan="7" class="text-center fw-bold">
                            <?= strtoupper('PENGKAJIAN DAN INTERVENSI RESIKO JATUH PADA PASIEN DEWASA (MORSE)') ?>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="7">
...
<script>
    ...
    function addRow() {
        ...
        row1.innerHTML = `
            <td rowspan="7">Nilai Resiko Jatuh</td>
            <td colspan="2">Faktor Resiko</td>
            <td >Nilai Skor</td>
            <td>
                <div>Tanggal/jam</div>
        ...
        row4.innerHTML = `
        <td class="">Kondisi Kesehatan</td>
        <td class="">Lebih dari satu diagnosa</td>
        ...
        row5.innerHTML = `
          <td class="">Bantuan Ambulansi</td>
        <td>
            <div class="d-flex flex-column gap-2">
                <div>Di tempat tidur/butuh bantuan perawat/memakai kursi roda</div>
                <div>Kruk, tongkat, walker</div>
                <div>Furniture: dinding, meja, kursi, almari</div>
            </div>
        </td>
        ...
        row6.innerHTML = `
        <td class="">Terapi IV/Anti Koagulan</td>
        <td>Terapi intravena terus menerus</td>
        ...
        row7.innerHTML = `
        <td class="">Gaya Berjalan/ Berpindah</td>
        <td>
            <div class="d-flex flex-column gap-2">
                <div>Normal/di tempat tidur/ immmobilisasi</div>
                <div>Lemah</div>
                <div>Terganggu</div>
            </div>
        </td>
        ...
        <td>
            <div class="d-flex flex-column gap-2">
                <div>Orientasi dengan kemampuan sendiri</div>
        ...
        <td class="" colspan="4">Resiko rendah (0-24), resiko sedang (25-44), resiko tinggi (≥45) (Lingkari)</td>
        ...
        rowIntervensi.innerHTML = `
            <td colspan="4">Intervensi pencegahan resikoj atuh (beritanda &check;)</td>
            <td>
    ...
    `;
        ...
        table.insertRow(baseIndex + 22).innerHTML = createRow('	3.	Penggunaan kate teruntuk BAK / pispot ', 'pispot');
