  ...
  <div class="col-12">
    ...
    <table class="table table-bordered border-dark" id="table-resiko">
      <tr>
        <td colspan="4">
          <p class="text-center">
            <strong>PENGKAJIAN DAN INTERVENSI RESIKO JATUH PADA PASIEN GERIETRI</strong>
          </p>
        </td>
        <td colspan="4">
      ...
      <tr>
        ...
        <td colspan="2"><input type="text" name="ket_rr_1[]" id="" class="form-control border-dark" placeholder="RR/RS/RT"></td>
        <td colspan="2"><input type="text" name="ket_rr_2[]" id="" class="form-control border-dark" placeholder="RR/RS/RT"></td>
        <td colspan="3"><input type="text" name="ket_rr_3[]" id="" class="form-control border-dark" placeholder="RR/RS/RT"></td>
      </tr>
      <tr>
        <td colspan="4">
