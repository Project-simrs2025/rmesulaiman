        ...
        <tr>
            ...
            <td>
                ...
                <div class="form-group mt-2">
                    ...
                    <input type="text" class="form-control border-dark" name="tanggal_lahir" id="tanggal_lahir" placeholder="Masukkan Tanggal Lahir">
                </div>

                <div class="form-group mt-2">
                    <label for="umur">Umur</label>
                    <input type="text" class="form-control border-dark" name="umur" id="umur" placeholder="Masukkan Tanggal Lahir">
                </div>
  ...
  `;
    ...
    function cbCommon(data) {
        ...
        for (let i = 0; i < rowCount; i++) {
            ...
            for (let kolom = 2; kolom <= 14; kolom++) {
