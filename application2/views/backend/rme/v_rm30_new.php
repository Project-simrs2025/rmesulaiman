<div class="row">
    <div class="d-flex flex-column gap-2">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <input type="text" name="nama_ruangan" id="" class="form-control border-dark">
        </div>
...
<script>
    ...
    function addRow() {
        ...
        row1.innerHTML = `
            ...
            <td colspan="3">
                <div class="d-flex align-items-center gap-2">
                    <div class="col-md-8">Timbang Terima</div>
                    <input type="date" name="tanggal_timbang[]" class="form-control border-dark w-25">
                </div>
            </td>
        ...
        row2.innerHTML = `
         <td>Diagnosa Medis</td>
             <td>
                <div class="">
                    <select style="width:210px;" name="diagnosa_pertama[]" id="diagnosa_pertama${rowCount}" class="form-select diagnosa_pertama"></select>
                    <input type="hidden" name="diagnosa_pertama_nama[]" class="diagnosa_pertama_nama">
                </div>
            </td>
             <td>
                <div class="">
                    <select style="width:210px;" name="diagnosa_kedua[]" id="diagnosa_kedua${rowCount}" class="form-select diagnosa_kedua"></select>
                    <input type="hidden" name="diagnosa_kedua_nama[]" class="diagnosa_kedua_nama">
                </div>
            </td>
            <td>
                <div class="">
                    <select style="width:210px;" name="diagnosa_ketiga[]" id="diagnosa_ketiga${rowCount}" class="form-select diagnosa_ketiga"></select>
        ...
        <td rowspan="3">Nama dan tanda tangan </td>
            ...
            <div>Pj Shift Pagi</div>
                <div class="">
                    <select name="perawat_pengkaji_pertama[]" id="perawat_pengkaji_pertama${rowCount}" class="form-select perawat_pengkaji_pertama" style="width:210px"></select>
             ...
             <td>
                ...
                <div>Pj Shift Sore</div>
                    <select name="perawat_pengkaji_kedua[]" id="perawat_pengkaji_kedua${rowCount}" class="form-select perawat_pengkaji_kedua" style="width:210px"></select>
            ...
            <td>
                ...
                <div>Pj Shift Malam</div>
                    <select name="perawat_pengkaji_ketiga[]" id="perawat_pengkaji_ketiga${rowCount}" class="form-select perawat_pengkaji_ketiga" style="width:210px"></select>
        ...
        rowTandaTangan2.innerHTML = `
            <td>
                <div class="">
                <div>Pj Shift Sore</div>
                    <select name="perawat_pengkaji2_pertama[]" id="perawat_pengkaji2_pertama${rowCount}" class="form-select perawat_pengkaji2_pertama" style="width:210px"></select>
             ...
             <td>
                <div class="">
                <div>Pj Shift Malam</div>
                    <select name="perawat_pengkaji2_kedua[]" id="perawat_pengkaji2_kedua${rowCount}" class="form-select perawat_pengkaji2_kedua" style="width:210px"></select>
            ...
            <td>
                <div class="">
                <div>Pj Shift Pagi</div>
                    <select name="perawat_pengkaji2_ketiga[]" id="perawat_pengkaji2_ketiga${rowCount}" class="form-select perawat_pengkaji2_ketiga" style="width:210px"></select>
        ...
        rowKaru.innerHTML = `
            <td>
                <div class="">
                <div>Karu</div>
                    <select name="karu_pertama[]" id="karu_pertama${rowCount}" class="form-select karu_pertama" style="width:210px"></select>
             ...
             <td>
                <div class="">
                <div>Karu</div>
                    <select name="karu_kedua[]" id="karu_kedua${rowCount}" class="form-select karu_kedua" style="width:210px"></select>
            ...
            <td>
                <div class="">
                <div>Karu</div>
                    <select name="karu_ketiga[]" id="karu_ketiga${rowCount}" class="form-select karu_ketiga" style="width:210px"></select>
    ...
    function cbCommon(data) {
        ...
        for (let i = 0; i < rowCount; i++) {
            ...
            // row 1
            const TanggalTimbang = dataObj['tanggal_timbang']?.[i] || '';
            ...
            rows[0].querySelector('input[name="tanggal_timbang[]"]').value = TanggalTimbang;
