                ...
                <td>
                    <div class="d-flex flex-column gap-2">
                        <div class="d-flex align-items-center gap-2">
                            <input type="checkbox" class="custom-checkbox-success" id="whole_blod" name="whole_blod"><label for="whole_blod">Whole blood</label>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <input type="checkbox" class="custom-checkbox-success" name="prc" id="prc"><label for="prc"> PRC</label>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <input type="checkbox" id="ffp" name="ffp" class="custom-checkbox-success"><label for="ffp"> FFP</label>
                        </div>
                    </div>
                </td>
                <td class="col-2">
                    <div class="col-6 d-flex align-items-center gap-2">
                        <input type="checkbox" class="custom-checkbox-success" id="trombosit" name="trombosit"><label for="trombosit">Trombosit</label>
                    </div>
                    <div>
                ...
                <td style="width: 300px;">
                    <div class="d-flex flex-column gap-2 align-items-center">
                        ...
                        <input type="hidden" id="image_drawer_state_image_11" name="image_drawer_state_image_11"
                            value="" />
                        <input type="text" class="form-control border-dark mt-2" name="nama_tdd_keluarga" placeholder="nama pasien / keluarga pasien">
                    </div>
                </td>
            </tr>
