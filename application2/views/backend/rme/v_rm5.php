	...
	<div class="col-12 form-group">
		...
		<div class="col">
			<div class="col form-group">
				<input class="custom-checkbox-success" type="checkbox" name="pasien" value="pasien" id="pasien">
				<label class="form-check-label" for="pasien">Pasien</label>
			</div>
			<div class="col form-group">
				<input class="custom-checkbox-success" type="checkbox" name="keluarga" value="keluarga" id="keluarga">
				<label class="form-check-label" for="keluarga">Keluarga</label>
			</div>
			<div class="col-10 form-group d-flex flex-wrap">
				<input class="custom-checkbox-success" type="checkbox" name="lain_check" value="" id="lain_check">
				<label class="form-check-label" for="lain_check"> Lainnya</label>
				...
				<div class="row">
					...
					<div class="col-12 mb-3">
						<div class="form-check form-check-inline">
							<input class="custom-checkbox-success" type="radio" name="kesadaran_choice" id="composMentis">
							<label class="form-check-label" for="composMentis">Compos Mentis</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="custom-checkbox-success" type="radio" name="kesadaran_choice" id="apatis">
							<label class="form-check-label" for="apatis">Apatis</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="custom-checkbox-success" type="radio" name="kesadaran_choice" id="somnolen">
							<label class="form-check-label" for="somnolen">Somnolen</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="custom-checkbox-success" type="radio" name="kesadaran_choice" id="sopor">
							<label class="form-check-label" for="sopor">Sopor</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="custom-checkbox-success" type="radio" name="kesadaran_choice" id="koma">
...
<div class="table-responsive">
	<table class="table table-bordered mt-5 border-dark">
		<tbody>
			...
			<tr>
				<td>
					<div class="mb-3">
						<div class="row mb-2">
							<div class="col-1">a.</div>
							<div class="col-2">Wanita:</div>
							<div class="col-2 flex-shrink-0">mentruasi</div>
							<div class="col-7">
								<div class="form-check form-check-inline">
			...
			<tr>
				<td colspan="2">
					<h6>Prioritas Masalah Keperawatan <small>(di isi oleh Perawat)</small></h6>
			...
			<tr>
				<td class="align-content-start">
					<u>DIAGNOSA KERJA</u><small> (di isi oleh Dokter)</small>
