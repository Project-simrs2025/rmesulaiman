...
<div class="container-fluid p-4 d-flex flex-column gap-3">
	<div class="alert alert-light-danger color-danger alert-dismissible show fade clear-notif-danger">
		<h5>Form CPPT ini sekarang hanya Mode Lihat, Silahkan menginput CPPT di CPPT NEW, Terima Kasih
	</h5>
					...
					?>
						<tr class="text-center">
							...
							<td><textarea name="profesional_pemberi_asuhan_<?php echo $i; ?>" id="" rows="4" class="form-control border-dark" style="width: 200px;"></textarea>
								<div class="my-2">Nama Pemberi profesional asuhan</div>
								<div class="my-2">
