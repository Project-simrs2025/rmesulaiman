...
<table class="table table-bordered mt-4 border-dark" id="VisiteProgramTable">
    ...
    <tbody>
        ...
        <tr class="text-center">
            <td>11</td>
            <td><input type="date" name="tanggal[]" class="form-control border-dark"></td>
            <td> <select type="select" name="dokter_umum11" id="dokter_umum11" class="form-select dokter_umum"
                    style="width: 100%;"></select></td>
            <td><input type="time" name="waktu_visit[]" class="form-control border-dark"></td>
            <td> <img class="img-responsive center-block mt-2" style="width: 20%;" id="qr_dokter_umum11" />
            </td>
        </tr>
        <tr class="text-center">
            <td>12</td>
            <td><input type="date" name="tanggal[]" class="form-control border-dark"></td>
            <td> <select type="select" name="dokter_umum12" id="dokter_umum12" class="form-select dokter_umum"
                    style="width: 100%;"></select></td>
            <td><input type="time" name="waktu_visit[]" class="form-control border-dark"></td>
            <td> <img class="img-responsive center-block mt-2" style="width: 20%;" id="qr_dokter_umum12" />
            </td>
        </tr>
        <tr class="text-center">
            <td>13</td>
            <td><input type="date" name="tanggal[]" class="form-control border-dark"></td>
            <td> <select type="select" name="dokter_umum13" id="dokter_umum13" class="form-select dokter_umum"
                    style="width: 100%;"></select></td>
            <td><input type="time" name="waktu_visit[]" class="form-control border-dark"></td>
            <td> <img class="img-responsive center-block mt-2" style="width: 20%;" id="qr_dokter_umum13" />
            </td>
        </tr>
        <!-- Initial Row -->
    </tbody>
