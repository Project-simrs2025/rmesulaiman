...
<script>
    ...
    function addRow() {
        ...
        const cells = [
         ...
         <input type="hidden" name="perawat_nama[]" class="perawat_nama">`,
            ...
            <textarea name="soap_p[]" rows="2" class="form-control border-dark"></textarea></div>
         </div>`,
    ...
    function cbCommon(data) {
        ...
        for (let i = 0; i < rowCount; i++) {
            ...
            // keterangan
            const soap_sKet = dataObj['soap_sKet']?.[i] || '';
            const soap_oKet = dataObj['soap_oKet']?.[i] || '';
            const soap_aKet = dataObj['soap_aKet']?.[i] || '';
            const soap_pKet = dataObj['soap_pKet']?.[i] || '';
