    ...
    <section id="input-validation">
        <div class="row">
            ...
            <div class="alert alert-light-warning color-warning alert-dismissible show fade clear-notif-warning">
                <h5>Cek Berkas PDF RME yang sudah di input disini! <span class="text-danger">Icon Merah artinya belum ada berkas untuk di klaim</span> , <span class="text-success">Icon Hijau artinya ada berkas untuk di Klaim</span></h5>
...
$(document).ready(function() {
    ...
    $('#mytable').on('click', '.download', function() {
        ...
        var url = site_url + "backend/data_klaim_view/download_all/" + id_kunjungan;
