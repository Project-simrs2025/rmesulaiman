                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row" id="basic-form">
                            ...
                            <div class="col-sm-6">
                                <label for="invalid-state">Whatsapp</label>
                            ...
                            <div class="col-sm-12 mt-4 mb-4">
                                <div class="form-floating">
                                    <textarea class="form-control detail_alamat" placeholder="Masukkan Detail Alamat" name="alamat"></textarea>
                        ...
                        <!------------------------------------------------------------------------------------------------>
                            ...
                            <div class="col-sm-6">
                                <label for="valid-state">Link Path TTD</label>
                                <input type="text" class="form-control detail_linkpath" name="linkpath"  placeholder="Link Path">
...
$this->security->get_csrf_hash(); ?>');
            ...
            if (id == "" || site_title == "" || email == "" || site_deskripsi == "" || notelp == "" || nama_kontak == "" || facebook == "" || instagram == "" || youtube == "" || telegram == "" || alamat == "") {
                            Swal.fire({
                                icon: "warning",
                                title: "Alert",
