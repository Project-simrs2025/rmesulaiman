                ...
                <tr>
                    <td rowspan="2">
                        <div class="form-group">
                            ...
                            <input type="text" id="alamat" name="alamat" class="form-control border border-dark" style="margin-left:-20%">
                        </div>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <input type="text" id="tgl_lahir" name="tgl_lahir" class="form-control w-50 border border-dark">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
